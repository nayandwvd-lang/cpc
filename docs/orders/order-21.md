---
title: "Order XXI — Execution of Decrees and Orders"
outline: 2
---

# Order XXI — Execution of Decrees and Orders

Order XXI is the longest Order in the Code — 106 rules — and it is where decrees go to die. A litigant who has won after eight years of trial and four of appeal discovers that the enforcement of his decree is a fresh litigation with its own pleadings, its own evidence, its own appeals, and its own capacity for delay. The Supreme Court has repeatedly observed that the difficulties of a decree-holder begin when the decree is passed.

The Order divides into seven working blocks. Rules 1 to 25 govern how money is paid and how execution is applied for and processed. Rules 26 to 29 govern stay. Rules 30 to 40 set out the modes of execution — against property, by arrest, for specific movables, for possession. Rules 41 to 57 govern attachment. Rules 58 to 63 govern third-party claims to attached property, the point at which execution most often becomes a trial. Rules 64 to 96 govern sale, the proclamation, and the grounds for setting a sale aside. Rules 97 to 106 govern resistance to the delivery of possession, and since 1976 they constitute a self-contained adjudicatory code whose determinations are decrees.

| Rules | Block | One-line function |
|---|---|---|
| **1–4** | Payment | Modes of paying money under a decree; the notice requirement; adjustment and certification |
| **10–14** | Application | Who may apply, to which court, in what form; oral application; the contents of the application |
| **15–25** | Process | Application by joint decree-holders; cross-decrees; **R. 22 notice to show cause**; transfer to another court |
| **26–29** | Stay | Stay by the executing court and by the court that passed the decree; security; **R. 29 stay pending a cross-suit** |
| **30–36** | Modes | Decree for payment of money; specific movable property; **RR. 32–33 specific performance, injunction, restitution of conjugal rights**; possession |
| **37–40** | Arrest | Discretionary notice; **s. 51 proviso — means and refusal**; the inquiry into means; detention in civil prison |
| **41–57** | Attachment | Examination of the judgment-debtor as to property; attachable and non-attachable property; the modes of attaching each species of property; **R. 54 attachment of immovable property** |
| **58–63** | Claims | **R. 58 adjudication of claims and objections** — determined by the executing court, appealable as a decree |
| **64–73** | Sale generally | Power to order sale; **R. 66 proclamation**; time between proclamation and sale; who may not bid; rateable distribution |
| **74–81** | Movables | Sale of movable property; negotiable instruments; shares |
| **82–96** | Immovables | Sale of immovable property; deposit by the purchaser; **RR. 89–91 setting aside the sale**; **R. 92 confirmation**; **R. 94 sale certificate** |
| **97–106** | Possession | **Resistance or obstruction to possession** — the self-contained code; **R. 101 all questions determined by the executing court**; **R. 103 determination to have the force of a decree** |

::: info The architecture in one breath
Execution begins with an **application** under Rule 11, which must satisfy Article 136 of the Limitation Act — **twelve years** from the date the decree became enforceable, a period which, unlike almost every other, cannot be extended by a fresh application. The court then issues **notice under Rule 22** in the defined cases, and thereafter selects a **mode**: attachment and sale of property, arrest, delivery of possession, or one of the specific modes in Rules 31 to 35. Attachment under Rules 41 to 57 creates no title — it merely prohibits alienation under **section 64** — and it may be defeated by a third party's claim under **Rule 58**, which the executing court must decide as though it were a suit, with the determination appealable as a decree. If attachment survives, the property is sold under Rules 64 to 96, and the sale becomes absolute only on **confirmation under Rule 92** after the windows under Rules 89, 90 and 91 have closed. Delivery of possession then follows, and if it is resisted, **Rules 97 to 106** provide a complete adjudicatory mechanism whose orders are decrees and are appealable as such. At every stage **section 47** confines the enquiry to execution, discharge and satisfaction, and forbids a separate suit.
:::
...
|---|---|---|
| "All money payable under a decree **shall** be paid as follows" (R. 1(1)) | **Mandatory, exhaustive** | Payment outside these three modes is at the payer's risk. The 1976 substitution was designed to stop the judgment-debtor's standard defence that he paid in cash without a receipt |
| "the judgment-debtor **shall give notice** thereof to the decree-holder" (R. 1(2)) | **Mandatory; condition for stopping interest** | Interest stops on the date of **service of the notice**, not the date of deposit. A deposit without notice continues to carry interest |
| "interest, if any, **shall cease to run** from the date of service of the notice" (R. 1(4)) | Mandatory consequence | The whole commercial point of Rule 1 |
| "where the decree-holder **refuses to accept** … interest shall cease to run from the date on which the money was **tendered**" (R. 1(5) proviso) | Protective | Defeats the decree-holder who declines payment in order to let interest accumulate |
| "the decree-holder **shall certify** such payment or adjustment" (R. 2(1)) | **Mandatory duty on the decree-holder** | Non-certification is a species of misconduct; the court may act on the judgment-debtor's application under R. 2(2) |
| "**No** payment or adjustment **shall** be recorded at the instance of the judgment-debtor unless…" (R. 2(2A)) | **Mandatory, exhaustive conditions** | Inserted in 1976. Oral evidence of an out-of-court cash payment is **not** enough — it must be by the Rule 1 modes, or documentary, or admitted |
| "**shall not be recognised** by any Court executing the decree" (R. 2(3)) | **Absolute bar** | An uncertified adjustment is a nullity in execution. This is the single most important sentence in Rules 1 to 25 for a judgment-debtor's advisers |
| "he **shall apply** to the Court which passed the decree or … to such Court" (R. 10) | Mandatory as to forum | Read with ss. 38, 39: execution is by the court that passed the decree, or the court to which it is transferred |
...
**(b) Limitation under Article 136 is twelve years and it does not renew.** This is the most misunderstood point in execution practice. Article 136 gives **twelve years** from the date the decree becomes enforceable — which for an ordinary decree is the date of the decree under Order XX Rule 7, and where the decree directs payment at a future date or in instalments, the date on which the default occurs. Crucially, the period is not extended by the making of intermediate execution applications. The *proceedings* may continue past twelve years once validly started, but a **fresh application** filed after twelve years is barred, however many applications preceded it. Compare Article 137's three years for other applications, and note that section 5 of the Limitation Act does **not** apply to Article 136 — there is no condonation.

**(c) Rule 22 notice is jurisdictional in substance if not in form.** The three cases are: an application more than two years after the decree; an application against a legal representative or under section 44A (foreign decrees of reciprocating territories); and an application against an assignee or receiver in insolvency. In each, the person proceeded against has not necessarily been heard on whether execution should issue against **him**. Failure to give notice is an irregularity that vitiates subsequent proceedings where prejudice is shown, and where the sale of immovable property follows, it is a standard ground under Rule 90.

**(d) The tabular application is a pleading.** Rule 11(2) requires ten particulars, and two of them are the judgment-debtor's principal weapons. Clause (e) requires the decree-holder to disclose any payment or adjustment; clause (f) requires disclosure of all previous applications with dates and results. A decree-holder who suppresses a part payment, or who conceals that an earlier application was dismissed on a finding of satisfaction, has verified a false application. Always obtain the execution file and read the tabular statement against the record before conceding anything.

**(e) Rules 15 and 18 — joint decree-holders and cross-decrees.** Where a decree is passed jointly in favour of several persons, any one of them may apply for execution of the whole decree, and the court will make an order for execution for the benefit of all. Where the parties hold **cross-decrees** for payment of money in separate suits, Rule 18 requires execution to be taken out only for the balance — the smaller decree is satisfied and satisfaction entered, and the holder of the larger executes only the difference. Rule 19 makes similar provision for cross-claims under the same decree. These are set-off provisions in execution, and they are frequently overlooked by a decree-holder who executes his full decree while ignoring the cross-decree against him.

**(f) Transfer of the decree for execution.** Where the judgment-debtor's property or person is outside the local limits of the court that passed the decree, the decree is transferred under sections 39 to 42 read with Rules 3 to 9. The transferee court then has the same powers as if it had passed the decree, but it does **not** acquire the power to entertain an objection that only the court that passed the decree can decide, and it cannot transfer the decree onward. Section 39(4), inserted in 1999, puts beyond doubt that the court that passed the decree cannot itself execute against person or property outside its jurisdiction. Practically: identify where the assets are before you file, because filing in the wrong court costs a year.

**(g) Rules 26 to 29 — stay, and the security condition.** The executing court **may** stay execution for a reasonable time to enable the judgment-debtor to apply to the court that passed the decree, or to an appellate court, for an order staying execution — but Rule 26(3) permits it to require security. Rule 29 is the provision practitioners forget: where a suit is pending in any court against the holder of a decree of that court, by the person against whom the decree was passed, the court may stay execution of the decree until the suit is disposed of. It is the answer to a decree-holder who sues on a promissory note while a substantial cross-suit for damages is pending against him.
...
>
> **(a)** issue notice to the judgment-debtor under Order XXI Rule 22 of the Code of Civil Procedure, 1908 to show cause why the decree dated [date] passed in [suit number] should not be executed against him;
>
> **(b)** direct the judgment-debtor to file an affidavit of assets in the prescribed form disclosing all movable and immovable property owned by him, in terms of the directions of the Hon'ble Supreme Court in *Rahul S. Shah v. Jinendra Kumar Gandhi*, (2021) 6 SCC 418;
>
> **(c)** attach the immovable property described in Schedule A hereto and the movable property described in Schedule B hereto, and after due proclamation under Order XXI Rule 66, bring the same to sale and satisfy the decretal sum of ₹[•] together with interest at [•] per cent per annum from [date] until realisation and the costs of this application out of the sale proceeds;
>
> **(d)** in the alternative, and in the event that the said properties are found insufficient, hold an enquiry under section 51 read with Order XXI Rule 40 into the means of the judgment-debtor and commit him to civil prison;
>
> **(e)** award the costs of this application; and
>
> **(f)** pass such further or other order as this Hon'ble Court may deem fit in the facts and circumstances of the case.

**Model prayer — application to record an adjustment under Order XXI Rule 2(2)**
...
| Operative expression | Character | Consequence |
|---|---|---|
| R. 26(1) "**shall**, upon sufficient cause being shown, stay… for a reasonable time" | **Mandatory** once sufficient cause is shown | The transferee court has no discretion to refuse a breathing space; but the stay is only to enable an approach to the decreeing or appellate court |
| R. 26(3) "**shall** require such security… or impose such conditions" | **Mandatory** | A stay without security or conditions is an order made contrary to the rule and is liable to be recalled |
| R. 27 "**No** order of restitution or discharge… shall prevent… being retaken" | Prohibitory / saving | Restitution under R. 26(2) is provisional; the property or person may be retaken when the stay lapses |
| R. 28 "shall be **binding** upon the Court to which the decree was sent" | **Mandatory** | The transferee court is subordinate on execution questions to the decreeing and appellate courts |
| R. 29 "**may**, on such terms as to security or otherwise… stay execution" | **Discretionary** | Requires a *pending suit by the judgment-debtor against the decree-holder in the same court*; a mere claim or notice is not enough |
| R. 29 proviso "the Court **shall**… record its reasons" (money decree, no security) | **Mandatory** (inserted 1999/2002) | A stay of a money decree without security and without recorded reasons is unsustainable |
| R. 30 "**may** be executed by… detention… or by attachment and sale… **or by both**" | Enabling; cumulative | The decree-holder may pursue arrest and attachment simultaneously; the choice is his, subject to s. 51 proviso |
| R. 31(1) "by the **seizure, if practicable**" | Conditional | Where seizure is impracticable, the rule falls back to detention or attachment — the decree is not thereby unexecutable |
| R. 31(2) attachment in force "for **three months**" | Condition precedent to sale | Sale of property attached for a specific-movable decree cannot be ordered before three months |
| R. 31(3) / R. 32(4) "the attachment **shall cease**" | **Automatic** | Six months' inaction extinguishes the attachment by operation of law; no order is needed and none can revive it |
| R. 32(1) "has had an **opportunity of obeying** the decree and has **wilfully failed** to obey it" | **Twin condition precedent** | Both must be found as facts before any coercive process issues; wilfulness is not presumed from non-compliance |
| R. 32(1) — RCR enforced **only** by attachment | Prohibitory | A decree for restitution of conjugal rights can never be enforced by detention; only specific performance and injunction decrees carry that sanction |
| R. 32(5) "in **lieu of or in addition to**… the act… be done by the decree-holder… at the cost of the judgment-debtor" | Enabling; the substituted-performance route | The most under-used provision in the Order — it converts an unenforceable mandatory injunction into a money claim |
| R. 34(5) execution of the document "**by a person nominated by the Court**" | Deeming | Court-executed conveyance has "the same effect as execution by the judgment-debtor"; specific-performance decrees do not require the defendant's cooperation |
| R. 35(3) "may… **break open any door**" after "reasonable warning" | Enabling, conditional | Force is lawful in delivery of possession, but only after warning and after facility to withdraw is given |
| R. 36 tenant "**not bound by the decree**" | Jurisdictional filter | Symbolic delivery only; actual dispossession of such an occupant must go through RR. 97–106 |
| R. 37(1) "the Court **shall**, instead of issuing a warrant… issue a notice" | **Mandatory**, subject to proviso | Arrest without a show-cause notice is illegal unless the abscondence proviso is invoked on affidavit and recorded |
| R. 39(1) "**No** judgment-debtor shall be arrested… unless and until the decree-holder pays… subsistence" | **Prohibitory condition precedent** | Non-deposit of subsistence money vitiates the arrest |
| R. 40(1) "the Court **shall proceed to hear**… and take all such evidence" | **Mandatory** | Detention on submissions alone, without evidence on means, is a nullity |
| s. 51 proviso "for **reasons recorded in writing**, is satisfied" | **Mandatory** | An order of detention without written reasons on (a), (b) or (c) is void; *Jolly George Verghese* reads Art. 21 into it |

::: warning The conceptual hinge — inability to pay is not a ground for prison
Section 51(c) permits detention, but its proviso all but abolishes imprisonment for simple insolvency. The decree-holder must prove **means plus refusal**, not merely non-payment. The distinction is between a debtor who *cannot* pay and one who *will not*: the first is a misfortune, and the Constitution forbids his imprisonment; the second is contumacy, and the Code punishes it.

This is not a matter of judicial sympathy. In *Jolly George Verghese v. Bank of Cochin* the Supreme Court read Article 11 of the International Covenant on Civil and Political Rights — "no one shall be imprisoned merely on the ground of inability to fulfil a contractual obligation" — into Article 21, and held that the proviso to section 51 must be construed so that detention follows only on a **present** finding of means and a **deliberate** refusal. Proof that the debtor once had means and spent them on necessities is not proof of refusal; proof that he had means and dissipated them to defeat the decree is.
...
**(b) Rule 29 is a different animal altogether — it is a cross-suit stay.** It applies where the *judgment-debtor* has filed a suit against the *decree-holder* in the same court which holds the decree. The rationale is set-off in embryo: if the debtor's claim succeeds, the decree may be wiped out or reduced, and executing in the meantime may be irreversible. But the conditions are strict. The suit must be **pending**, it must be **by the judgment-debtor against the decree-holder**, and it must be in the **same court** which passed or is executing the decree. A suit in another court, a suit by a stranger, or a mere legal notice will not do. And after the 1999/2002 amendments, if the decree is for money and the court stays it without security, it **must record reasons** — the legislature's response to the routine practice of paralysing money decrees by filing a counter-suit.

**(c) The modes of execution are a menu, not a sequence.** Section 51 lists them — delivery, attachment and sale, arrest and detention, appointment of a receiver, and "such other manner as the nature of the relief requires". Rule 30 confirms that a money decree may be executed by detention *or* attachment *or* **both**. There is no rule of election and no rule that attachment must be exhausted before arrest is sought. But the section 51 proviso means that in practice the arrest route requires a factual foundation that only an attachment enquiry usually produces, so the sequencing is imposed by evidence rather than by law.

**(d) Rules 31 to 36 are the *specific* modes, matched to the species of decree.** A decree for a specific movable (Rule 31) is executed by seizing the thing itself — the point is that the decree-holder wanted the chattel, not damages. A decree for specific performance or an injunction (Rule 32) is enforced by detention or attachment, because there is nothing to seize; a decree for restitution of conjugal rights is enforced *only* by attachment, since imprisoning a spouse to compel cohabitation would be indefensible. A decree for the execution of a document (Rule 34) is enforced by the court executing the document itself through a nominated officer. And a decree for immovable property (Rule 35) is enforced by physically putting the decree-holder in, breaking a lock if necessary.

**(e) The twin conditions in Rule 32(1) are the whole of the rule.** "Has had an opportunity of obeying the decree" and "has wilfully failed to obey it". Both are findings of fact. A defendant who could not comply because the decree was ambiguous, or because a third party had intervened, or because the time for compliance had not expired, has not had an opportunity. A defendant who did not comply because he misread the decree, or because his advocate advised that an appeal operated as a stay, has not *wilfully* failed. This is why Rule 32 applications so often fail: the applicant proves non-compliance and stops, when the rule requires him to prove contumacy.

**(f) Rule 32(5) is the most valuable and least used provision in the Order.** Where a mandatory injunction or a decree for specific performance is not obeyed, the court may direct that **the act be done by the decree-holder or a person appointed by the court, at the judgment-debtor's cost**, and the expenses are then recoverable **as if they were included in the decree**. This converts an intractable enforcement problem — how do you make a man demolish his own wall? — into a money recovery. Ask for it in the alternative in every Rule 32 application: demolish the encroachment through a court commissioner, ascertain the cost, and add it to the decretal sum.

**(g) The three-month and six-month clocks in Rules 31 and 32 run against the decree-holder.** Attachment under these rules is a *coercive* attachment — its purpose is pressure, not realisation. So the Code will not let it sit indefinitely. Under Rule 31, the attached property cannot be sold before three months; under both rules, if no application to sell is made within six months, the **attachment ceases automatically**. There is no provision for extension and no application to revive. A decree-holder who obtains an attachment under Rule 32 and then lets the file sleep will find, on the 181st day, that he has nothing.

**(h) Rule 35 versus Rule 36 — actual delivery and symbolic delivery.** If the person in possession is *bound by the decree* — the defendant, his family, his employees, a transferee *pendente lite* — Rule 35 applies and he is physically removed. If the person in possession is a **tenant or other person entitled to occupy and not bound by the decree**, Rule 36 applies and the delivery is symbolic: a copy of the warrant is affixed and the substance of the decree is proclaimed by beat of drum. The occupant stays. This is not a defect in the decree; it reflects that a decree binds parties and privies, not the world. To dispossess such an occupant, the decree-holder must go through Rules 97 to 106 and obtain an adjudication that the occupant's possession is not on his own independent right.

**(i) Arrest is a three-stage process, and skipping a stage voids it.** Stage one is the **Rule 37 notice** — the court "shall" issue a show-cause notice instead of a warrant, unless satisfied on affidavit that the debtor is likely to abscond. Stage two is the **Rule 40 inquiry** — the court hears the decree-holder, takes his evidence, and gives the debtor an opportunity to show cause. Stage three is the **section 51 proviso finding** — the court must record in writing that one of (a), (b) or (c) is made out. Each stage is a separate protection, and each has been held to be mandatory.

**(j) Subsistence money is a condition precedent, not a formality.** Rule 39 prohibits arrest "unless and until" the decree-holder deposits subsistence. The rate is fixed by the State Government by scales published for the class to which the debtor belongs. The money is deemed to be costs in the suit and is recoverable — but critically, the proviso to Rule 39(4) provides that the judgment-debtor **shall not be detained or arrested on account of the subsistence money itself**, so the decree-holder cannot manufacture a fresh ground for detention out of the cost of the first.
...
| Trigger | Provision | Interlocking Order/Rule | Limitation / fee | Application to file |
|---|---|---|---|---|
| Decree sent to another court; debtor wants to approach the decreeing court | O. XXI R. 26(1) | ss. 39–42; R. 28 binding effect | No period — but "reasonable time" only | Application for stay before the transferee court, with proof of the parallel application |
| Property already seized; debtor seeks release pending the stay application | O. XXI R. 26(2)–(3) | R. 27 — property may be retaken | — | Application for restitution, offering security |
| Appeal filed against the decree | **O. XLI R. 5** (not O. XXI) | Mere filing of an appeal does **not** stay execution — s. 96 with O. XLI R. 5(1) | Appeal: **Article 116/117** — 90 days to HC, 30 days to district court | Stay application under O. XLI R. 5; R. 5(3) conditions — substantial loss, no delay, security |
| Judgment-debtor has filed a suit against the decree-holder in the same court | O. XXI R. 29 | Compare s. 10 (stay of suits) — different test entirely | — | Application under R. 29, offering security; reasons mandatory if money decree and no security |
| Money decree; you want both arrest and attachment | O. XXI R. 30 with **s. 51** | RR. 37–40 for arrest; RR. 41–57 for attachment | Art. 136 | Single EA praying both, in the alternative |
| Decree for a specific movable not delivered | O. XXI R. 31 | s. 51(a); Specific Relief Act ss. 7–8 | Sale only after **3 months**; attachment ceases at **6 months** | EA for seizure; then application to sell the attached property |
| Specific performance decree not obeyed | O. XXI R. 32(1), R. 34 | Specific Relief Act s. 28 — power of the **court which passed the decree** to rescind on non-payment | Art. 136; s. 28 application to the trial court, not the executing court | EA under R. 32; separately, application under R. 34 for execution of the sale deed by a court nominee |
| Injunction decree violated | O. XXI R. 32(1) and R. 32(5) | **O. XXXIX R. 2A** for interim injunctions; Contempt of Courts Act, 1971 s. 2(b) | — | R. 32 application; alternative prayer for substituted performance at the debtor's cost |
| Restitution of conjugal rights decree not obeyed | O. XXI R. 32(1) (attachment **only**) and R. 33 | Hindu Marriage Act s. 9 and **s. 13(1A)(ii)** — divorce after one year's non-resumption | One year from the decree for s. 13(1A)(ii) | R. 33 application for periodical payments; or a divorce petition |
| Decree for execution of a sale deed; debtor refuses to sign | O. XXI R. 34(1)–(5) | Registration Act, 1908 s. 17; Stamp Act Art. 23 | Registration within **4 months** of execution, s. 23 Registration Act | Application with a draft conveyance; court nominates an officer to execute |
| Possession decreed; occupant bound by the decree | O. XXI R. 35(1) and (3) | s. 52 Transfer of Property Act — *lis pendens* | — | Warrant of delivery; police assistance under s. 151 if resisted |
| Possession decreed; occupant a tenant **not** bound | O. XXI R. 36 | RR. 97–101 to convert symbolic into actual delivery | **Article 129 — thirty days** to complain of resistance | Take symbolic delivery; then R. 97 application |
| Arrest sought in a money decree | O. XXI R. 37(1) with **s. 51 proviso** | R. 40 inquiry; R. 39 subsistence; **s. 58** maximum period | s. 58: **3 months** if decree > ₹5,000; **6 weeks** if > ₹2,000 ≤ ₹5,000; **no arrest** if ≤ ₹2,000 | EA praying arrest; affidavit under the R. 37 proviso if abscondence alleged |
| Debtor is a woman, a judicial officer, a legislator | **s. 56** (women) ; **s. 135** (exemptions) | s. 56 — absolute bar on arrest of a woman in execution of a money decree | — | Object at the threshold; the bar is jurisdictional |
| Debtor claims he cannot pay | s. 51 proviso (b); **s. 55(3)–(4)** | Insolvency legislation; **IBC 2016** for corporate debtors and s. 94 for personal guarantors | — | Application to be declared insolvent; moratorium under IBC s. 96/101 if applicable |
...
**Ratio decidendi:** Article 11 of the International Covenant on Civil and Political Rights — that no one shall be imprisoned merely for inability to fulfil a contractual obligation — informs the construction of Article 21 and of the proviso to section 51. Detention is permissible only where the court records, on evidence, that the judgment-debtor **has or has had since the decree the means to pay and has refused or neglected to pay**, or has dishonestly dealt with his property to defeat the decree. "The simple default to discharge is not enough" — there must be an element of bad faith beyond mere indifference.

::: tip Practitioner Takeaway
"In *Jolly George Verghese v. Bank of Cochin*, this Hon'ble Court held that the proviso to section 51 forbids detention on the mere fact of non-payment, and requires a positive finding, recorded in writing on evidence, that the judgment-debtor has present or post-decretal means and has deliberately refused to pay; the decree-holder has led no evidence whatever on means, and the application must therefore be dismissed at the threshold."
:::

**Babu Lal v. Hazari Lal Kishori Lal, (1982) 1 SCC 525** — 3-Judge Bench.
*Facts:* Execution of a decree for specific performance where the decree-holder had not deposited the balance consideration within the time fixed, and the judgment-debtor sought to have the decree treated as spent.

**Ratio decidendi:** The time fixed in a decree for specific performance for payment of the balance consideration is **not** of the essence, and the failure to pay within it does not automatically rescind the decree. The remedy of the judgment-debtor is an application under **section 28 of the Specific Relief Act, 1963 to the court which passed the decree** — not an objection in execution — and that court retains a discretion to extend time. Order XXI Rule 34 governs the mechanics of getting the conveyance executed once the price is paid.

::: tip Practitioner Takeaway
"The time fixed by a decree for specific performance for deposit of the balance consideration is not of the essence, and the decree does not stand rescinded by mere default; the only remedy is an application under section 28 of the Specific Relief Act, 1963 to the court which passed the decree, and no such application having been made, the executing court is bound to execute the decree and to have the conveyance executed under Order XXI Rule 34."
:::

**Shakuntala Devi Jain v. Kuntal Kumari, AIR 1969 SC 575** — 3-Judge Bench.
*Facts:* Concerned the approach to stay and to the exercise of discretion where execution would render an appeal nugatory.

**Ratio decidendi:** Where the execution of a decree would defeat the very purpose of a pending appeal by creating an irreversible situation, the appellate court's discretion under Order XLI Rule 5 must be exercised to preserve the subject matter; but the discretion is not exercised as of course, and the applicant must satisfy the tests of substantial loss, absence of unreasonable delay, and the furnishing of security.

::: tip Practitioner Takeaway
"The mere preferring of an appeal does not operate as a stay of the decree; the applicant must independently satisfy this Hon'ble Court on all three conditions in Order XLI Rule 5(3) — substantial loss, absence of unreasonable delay, and security for the due performance of the decree — and the application in hand pleads none of them."
:::

**Ram Karan Das v. Bhagwan Das, AIR 1965 SC 1144** — Constitution-strength consideration of executing-court powers.
*Facts:* Whether the executing court could refuse to execute a decree it considered erroneous.

**Ratio decidendi:** The executing court must take the decree as it stands and cannot question its correctness or legality, however erroneous; it may, however, construe the decree in order to ascertain what it in fact directs, and in doing so may look at the pleadings and the judgment where the decree is ambiguous.

::: tip Practitioner Takeaway
"An executing court may construe an ambiguous decree by reference to the judgment and pleadings in order to ascertain what it directs, but it may not sit in appeal over the decree; the objection presently raised does not seek construction but seeks a re-adjudication of a finding concluded by the decree, and is not maintainable."
:::

**Rahul S. Shah v. Jinendra Kumar Gandhi, (2021) 6 SCC 418** — 3-Judge Bench (applied to modes).
*Facts:* Systemic delay in executing decrees for immovable property.

**Ratio decidendi:** Among the mandatory directions issued, the executing court must, in a decree for immovable property, **direct the judgment-debtor to file an affidavit of assets** and, where obstruction is offered, decide the question under Rules 97 to 106 within a time frame rather than relegating the parties to a suit; the court "shall not entertain any objection which could have been raised at the stage of trial".

::: tip Practitioner Takeaway
"This Hon'ble Court is respectfully requested to direct the judgment-debtor to file an affidavit of assets in terms of direction (v) in *Rahul S. Shah v. Jinendra Kumar Gandhi*, (2021) 6 SCC 418, without which neither the mode of execution nor the enquiry into means under section 51 can be meaningfully undertaken."
:::
...
2. **Seeking detention of a woman in a money decree.** Section 56 is an absolute bar. It is astonishing how often this is missed where the judgment-debtor is one of several defendants.
3. **Filing a Rule 32 application that proves non-compliance but not wilfulness.** The rule requires *opportunity* plus *wilful failure*. Draft two separate paragraphs, headed as such, with documents under each. An application that merges them invites a finding that the twin conditions were never addressed.
4. **Omitting the Rule 32(5) alternative.** If the court is not prepared to imprison, and you have not offered substituted performance, the court has nothing to grant and will adjourn. Always plead Rule 32(5) in the alternative, with a costed proposal.
5. **Taking symbolic delivery under Rule 36 and treating the execution as closed.** Symbolic delivery against a non-party occupant does not give you possession, and Article 129 gives only **thirty days** to complain of resistance or obstruction. File the Rule 97 application immediately; the thirty-day period is the single most missed limitation in the whole Order.
6. **Assuming the appeal stays the decree.** It does not. Section 96 read with Order XLI Rule 5(1) is explicit: an appeal shall not operate as a stay unless the court so orders. Judgment-debtors who file an appeal and go home find their property attached; decree-holders who wait for the appeal to be decided lose years of Article 136.
:::

::: warning Strategic timing — the sequence that actually works
**Month 0 — file the EA and ask for three things at once:** notice under Rule 22, an affidavit of assets under Rule 41 read with *Rahul S. Shah*, and, where alienation is apprehended, attachment under the proviso to Rule 22(2) without notice for reasons recorded.

**Month 1–2 — run the Rule 41 examination.** Cross-examine the judgment-debtor on the affidavit. Every concealed asset is a brick in the section 51 proviso wall, and a false affidavit is punishable under section 229 of the Bharatiya Nyaya Sanhita, 2023 (formerly section 193 IPC), which is worth stating in the notice.

**Month 2–3 — elect the mode.** If assets have surfaced: attach and proceed to sale under Rules 64 onwards. If assets have been dissipated after the decree: apply for arrest on limb (a)(ii) of the section 51 proviso, which does not require present means at all — dishonest transfer after the institution of the suit is sufficient by itself.

**For the judgment-debtor — the mirror timing.** Disclose fully and early. A candid affidavit of assets destroys limb (a)(ii), forces the enquiry onto limb (b) where the burden is heaviest, and positions you to offer instalments. If a genuine cross-claim exists, file the suit and move under Rule 29 **before** the attachment, not after — a Rule 29 stay sought after property has been attached and proclaimed will be read as obstruction. And if the decree is for money and you cannot furnish security, address the proviso to Rule 29 expressly: give the court the reasons it is required to record.
:::

**Model prayer — application for arrest and detention under Order XXI Rules 37 and 40**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** issue notice to the judgment-debtor under Order XXI Rule 37(1) calling upon him to show cause why he should not be committed to the civil prison in execution of the decree dated [•];
>
> **(b)** hold an inquiry under Order XXI Rule 40 and permit the applicant to lead evidence, including by summoning the records of Account No. [•] with [bank] under Order XVI Rule 6, in proof of the judgment-debtor's means;
>
> **(c)** record a finding under clause (a)(ii) of the proviso to section 51 that the judgment-debtor, after the institution of the suit, dishonestly transferred the property described in the Schedule by gift deed dated [•] with the object and effect of obstructing the execution of the decree;
>
> **(d)** commit the judgment-debtor to the civil prison for a period of three months under section 58(1)(a), the decretal sum exceeding five thousand rupees; the applicant undertaking to deposit subsistence allowance at the notified scale in terms of Order XXI Rule 39 within [•] days of the order; and
>
> **(e)** pass such further or other order as may be just.

**Model prayer — application under Order XXI Rule 32 for an injunction decree**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** hold that the judgment-debtor has had an opportunity of obeying the decree dated [•] and has wilfully failed to obey it;
>
> **(b)** attach the immovable property described in the Schedule under Order XXI Rule 32(1), and in the event of continued disobedience for six months, bring the same to sale under Rule 32(3) and award the applicant compensation out of the proceeds;
>
> **(c)** in the alternative and in addition, direct under **Order XXI Rule 32(5)** that the acts required by the decree, namely [•], be done by a commissioner appointed by this Hon'ble Court at the cost of the judgment-debtor, the expenses so incurred to be ascertained and recovered as if they were included in the decree;
>
> **(d)** commit the judgment-debtor to the civil prison; and
>
> **(e)** award costs.

| # | Checklist — before seeking arrest or coercive process | Provision |
|---|---|---|
| 1 | Judgment-debtor is not a woman; not otherwise exempt | ss. 56, 135, 135A |
| 2 | Decretal amount exceeds ₹2,000, and the maximum period computed | s. 58(1) |
| 3 | No moratorium operating under IBC s. 14 or s. 96 | IBC, 2016 |
| 4 | Rule 41 examination completed and an affidavit of assets on record | O. XXI R. 41 |
| 5 | Section 51 proviso limb identified — (a)(i), (a)(ii), (b) or (c) — and pleaded separately | s. 51 proviso |
| 6 | Rule 37 notice prayed for, or the abscondence proviso invoked **on affidavit** | O. XXI R. 37(1) |
| 7 | Subsistence allowance computed at the notified State scale and undertaking given | O. XXI R. 39 |
| 8 | Evidence ready for the Rule 40 inquiry — witnesses, bank records, mutation entries | O. XXI R. 40(1) |
| 9 | For a R. 32 application — opportunity and wilfulness pleaded in separate paragraphs with documents | O. XXI R. 32(1) |
| 10 | Rule 32(5) substituted performance pleaded in the alternative, with a costed proposal | O. XXI R. 32(5) |
| 11 | Attachment under R. 31/R. 32 diarised — sale application before the six-month cesser | O. XXI RR. 31(3), 32(4) |
| 12 | For possession — occupant identified as bound (R. 35) or not bound (R. 36) before the warrant issues | O. XXI RR. 35, 36 |
| 13 | If symbolic delivery is taken — R. 97 application filed within thirty days | Art. 129, Limitation Act |
...
| Operative expression | Character | Consequence |
|---|---|---|
| R. 41(2) "the Court **may**… require… **an affidavit stating the particulars of the assets**" | Enabling, after **thirty days** of non-satisfaction | The single most useful order in execution; ask for it in the EA itself |
| R. 41(3) "may **detain him in the civil prison** for a term not exceeding three months" | Penal, for **disobedience of the asset-affidavit order** | Detention here does **not** require the s. 51 proviso findings — it punishes contempt of the order, not the default |
| s. 60(1) "all other **saleable** property… belonging to the judgment-debtor, or over which… he has a **disposing power**" | Definitional | Attachability turns on saleability plus beneficial disposing power; a mere right to sue, a personal licence, or a *spes successionis* is not attachable |
| s. 60(1) proviso — enumerated exemptions | **Prohibitory** | An attachment of exempt property is without jurisdiction and is set aside on objection; the exemptions cannot be waived by agreement |
| s. 60 proviso (i) salary — "first **one thousand rupees** and **two-thirds** of the remainder" | Quantified exemption | Only one-third of the salary above ₹1,000 is attachable; and under s. 60(1A), the attachment is limited to twenty-four months in a decree-holder's favour |
| **s. 64(1)** "any private transfer… **shall be void as against all claims enforceable under the attachment**" | **Voiding, but only relatively** | The transfer is good between transferor and transferee; it is void only against the attaching creditor. Attachment creates **no charge and no title** |
| **s. 64(2)** — saving for a **contract registered before the attachment** | Exception (inserted 2002) | An agreement to sell registered before attachment defeats the attachment; an unregistered agreement does not |
| R. 43 movables in possession — "by **actual seizure**" | **Mandatory mode** | Constructive attachment of movables in the debtor's own possession is not recognised |
| R. 46 debts, shares, property not in possession — "by a **written order prohibiting**" | **Mandatory mode** | No seizure; the prohibition binds the third party from the moment of service |
| R. 46A garnishee "calling upon him either to **pay into Court**… or… show cause" | Enabling | Converts the debtor's debtor into a direct source of realisation; the garnishee's own defences are tried summarily |
| R. 54(1) immovable — order "**prohibiting** the judgment-debtor from transferring or charging" | **Mandatory mode** | The order is the attachment; without a Rule 54 order there is no attachment at all |
| R. 54(2) proclamation and affixture — "**shall** be proclaimed… and a copy… **shall** be affixed" | **Mandatory but directory in effect** | Non-compliance is a material irregularity under R. 90, not a nullity; but see R. 54(4) |
| R. 54(4) effect against "**purchasers for value in good faith**, from the time… affixed on the property" | Timing rule | Against a bona fide purchaser, the attachment bites only from affixture; against everyone else, from the date of the order |
| R. 55 "the attachment **shall be deemed to be withdrawn**" | **Automatic** | Payment, certified satisfaction or reversal of the decree extinguishes the attachment without any order |
| R. 57(2) "the attachment shall be **deemed to have ceased**" | **Automatic** (1976) | If the EA is dismissed and the court is silent, the attachment dies. Always obtain an express continuation direction |
| R. 58(1) "the Court **shall proceed to adjudicate**" | **Mandatory** | The executing court has no discretion to relegate the claimant to a suit — that was the pre-1976 position and it is gone |
| R. 58(1) proviso (a) "where… the property attached has **already been sold**" | **Jurisdictional bar** | A claim after sale is not entertainable under R. 58 at all; the remedy is R. 91 or a suit |
| R. 58(2) "**shall be determined by the Court**… and **not by a separate suit**" | **Exclusionary** | Title questions are tried in execution; a parallel title suit is barred |
| R. 58(4) "the order… shall have the **same force**… as if it were a **decree**" | Deeming | Appealable as a decree under s. 96; no revision, no O. XLIII appeal |
| R. 58(5) / R. 63 — suit preserved **only** where the claim was refused entertainment under the proviso | Narrow saving | If the claim was adjudicated, the order is conclusive and a suit is barred |

::: warning The conceptual hinge — attachment secures priority, it does not create title
Attachment is the most misunderstood step in execution because litigants treat it as an acquisition. It is not. Section 64 says only that a private transfer after attachment is "void **as against all claims enforceable under the attachment**". Three consequences follow, and each of them decides cases:

**First**, the transfer is perfectly valid *inter se* transferor and transferee. If the decree is later satisfied, reversed, or the attachment ceases under Rule 55 or Rule 57(2), the transfer stands unaffected and the transferee takes good title.

**Second**, the attaching creditor acquires **no charge, no lien and no interest in the property**. He acquires a right to have the property sold in execution free of the offending transfer. That is why a prior mortgagee, a prior registered agreement-holder under section 64(2), or a person with an antecedent title always defeats the attaching creditor — and why an attachment confers no priority over a secured creditor under the SARFAESI Act or a resolution professional under the IBC.
...
**(b) Section 60 defines the pool, and its proviso defines the floor.** Anything saleable which the debtor owns or over which he has a beneficial disposing power is attachable, including property held benami in another's name for him. Against that, the proviso protects a subsistence floor: wearing apparel, cooking vessels, beds, a woman's religiously inalienable ornaments, an artisan's tools, an agriculturist's implements and the house he occupies, a right to future maintenance, provident fund and life-insurance monies, and salary to the extent of the first ₹1,000 and two-thirds of the remainder. These are not concessions the court may waive; an agreement by the debtor to allow attachment of exempt property is void under section 60(1) proviso read with the *Explanation*.

**(c) The mode of attachment depends entirely on the species of property, and using the wrong mode is fatal.** Movables in the debtor's possession — **actual seizure** (Rule 43). Agricultural produce — Rule 44, by affixture on the land and on the debtor's house. Debts, shares, and movables not in the debtor's possession — a **written prohibitory order** (Rule 46). A debt owed by an identifiable third party — the **garnishee route** under Rules 46A to 46I. Property in the custody of a court or public officer — **notice** to that court or officer (Rule 52). A partner's interest in a firm — a **charging order** under Rule 49, and never a seizure of firm assets. Immovable property — a **prohibitory order** under Rule 54, proclaimed and affixed. Attach a debt by seizure, or a share by taking the certificate, and there is no attachment in law.

**(d) The garnishee procedure is a parallel recovery mechanism.** Rules 46A to 46I let the decree-holder pull in the debtor's debtor. Notice issues; the garnishee either pays into court or shows cause. If he disputes liability, the court may order the question tried, and Rule 46C provides that the issue is tried as though it were an issue in a suit. Payment by a garnishee under the order is a **valid discharge** to him against the judgment-debtor (Rule 46D and Rule 46I). Bank accounts, security deposits with a landlord, retention money with a principal contractor and receivables from a customer are all reachable this way, and it is very much faster than attachment and sale.

**(e) Rule 54 attachment of immovable property is a formality with a substantive core.** The *attachment* is the prohibitory order. The proclamation by beat of drum, the affixture on the property and on the court-house, the copy to the Collector and the Gram Panchayat, and the gazette or newspaper publication where directed, are the *publicity* of it. Rule 54(4) then sets the timing: against a purchaser for value in good faith the order operates only from the moment a copy is affixed on the property; against everybody else, from the moment the order is made. So an execution clerk's failure to affix the copy does not destroy the attachment, but it creates a window in which an innocent purchaser may take good title.

**(f) Two rules kill attachments silently — Rule 55 and Rule 57(2).** Rule 55 deems the attachment withdrawn when the decretal amount and charges are paid, when satisfaction is certified, or when the decree is reversed. Rule 57(2), inserted in 1976, is more dangerous: if the execution application is **dismissed for any reason** — including for default of appearance or non-deposit of process fee — and the court omits to direct that the attachment shall continue, the attachment is **deemed to have ceased**. Decree-holders lose attachments this way constantly. Whenever an EA is dismissed, even by consent or for statistical disposal, ask for and obtain an express direction under Rule 57(1) that the attachment continues, and get the date recorded.

**(g) Rule 58 is a suit conducted inside the execution.** Before 1976, a claim to attached property was decided summarily, and the losing party had a year in which to file a regular suit under the old Rule 63. The 1976 amendment reversed this architecture. Now the executing court **must** adjudicate — "shall proceed to adjudicate" — and it must decide **all questions including questions of right, title or interest** (sub-rule (2)), and the resulting order is **deemed a decree** (sub-rule (4)), appealable as such. The separate suit survives only in the narrow case where the court declined to entertain the claim under the proviso, i.e. because the property had already been sold or because the claim was designedly delayed.

**(h) The two bars in the proviso to Rule 58(1) do different work.** Bar (a) — "already been sold" — is jurisdictional and mechanical: once the property is sold, the attachment has spent itself and the claimant's remedy shifts to Rule 91 (setting aside a sale on the ground that the judgment-debtor had no saleable interest) or to a suit. Bar (b) — "designedly or unnecessarily delayed" — is a finding of fact, and it exists because the classic obstruction tactic is for a relative of the judgment-debtor to surface with a claim on the eve of the auction. A court refusing entertainment under bar (b) must record why, and its refusal, though it leaves the claimant to a suit under sub-rule (5), is conclusive unless that suit succeeds.

**(i) The standard the claimant must meet is possession-plus-title, not title alone.** Rule 58 asks whether the property "is not liable to such attachment". The classic enquiry is whether, at the date of the attachment, the property was in the possession of the claimant **on his own account** and not on account of the judgment-debtor. A claimant with a paper title but no possession, and a claimant in possession as the judgment-debtor's licensee or benamidar, both fail. Conversely a claimant in possession under a registered agreement to sell entered into and registered before the attachment succeeds squarely under **section 64(2)**.
...
| Trigger | Provision | Interlocking Order/Rule | Limitation / fee | Application to file |
|---|---|---|---|---|
| Decree unsatisfied for thirty days; assets unknown | **O. XXI R. 41(2)** | R. 41(3) — three months' detention for disobedience; *Rahul S. Shah* direction | Thirty days must have elapsed | Application for an order directing an affidavit of assets |
| Debtor files a false affidavit of assets | R. 41(2) | **BNS 2023 s. 229** (formerly IPC s. 193); **BNSS 2023 s. 379** (formerly CrPC s. 340) complaint | — | Application under BNSS s. 379 for a complaint by the court |
| You need third-party information about the debtor's assets | R. 41(1)(c) — "any other person" | O. XVI R. 6 — summons to produce documents | — | Application to examine the banker/accountant and produce books |
| Attaching movables in the debtor's own possession | O. XXI R. 43 | R. 43A custody; R. 45 attachment of negotiable instruments by actual seizure | — | Warrant of attachment; bailiff's inventory mandatory |
| Attaching a bank balance or a receivable | O. XXI R. 46(1)(a) and **RR. 46A–46I** | R. 46D trial of the garnishee's dispute; R. 46I discharge of the garnishee | — | Prohibitory order plus garnishee notice |
| Attaching salary | s. 60 proviso (i) with **s. 60(1A)** | Only one-third above ₹1,000; attachment limited to 24 months | — | Prohibitory order on the employer under R. 48 |
| Attaching shares | O. XXI R. 46(1)(b) | Depositories Act, 1996 — freeze on the demat account | — | Prohibitory order to the company, the depository and the DP |
| Attaching a partner's interest | **O. XXI R. 49** | Charging order only; firm property cannot be seized for a partner's personal decree | — | Application for a charging order on the partner's share and profits |
| Attaching money lying in another court | O. XXI R. 52 | s. 73 rateable distribution if multiple decree-holders | Application must precede receipt of assets | Notice to the court/public officer holding the funds |
| Attaching immovable property | **O. XXI R. 54** | s. 64 voiding of private transfers; R. 54(4) timing against bona fide purchasers | Art. 136 for the underlying EA | Application for a prohibitory order; ensure affixture and Collector/Panchayat copies |
| Debtor transfers after attachment | **s. 64(1)** | s. 64(2) exception for a **registered** pre-attachment contract; s. 53 TPA for fraudulent transfers | Art. 59 — three years to set aside under s. 53 TPA | Objection in execution; or a s. 53 TPA suit |
| Decree satisfied / reversed | O. XXI R. 55 | Attachment "deemed to be withdrawn" — no order needed | — | Application to record satisfaction under R. 2 |
| EA dismissed for any reason | **O. XXI R. 57(1)–(2)** | Silence = deemed cesser | — | Insist on an express direction continuing the attachment, with the period stated |
| Third party claims the attached property | **O. XXI R. 58(1)–(4)** | R. 59 stay of sale; R. 58(4) order deemed a decree | Reasonable promptness; **proviso (b)** bars delayed claims | Claim petition with an application under R. 59 in the same breath |
| Claim refused entertainment under the proviso | O. XXI R. 58(5) and **R. 63** | Suit preserved; the R. 58 order otherwise conclusive | **Article 58 — three years** from when the right to sue accrues | Regular suit for declaration and injunction |
| Claim dismissed on merits under R. 58 | R. 58(4) | Appeal as from a decree — **s. 96**; no revision under s. 115 | **Article 116/117** — 90 or 30 days | First appeal, not a revision — this is the most common error |
| Property sold before the claim is made | O. XXI R. 58 proviso (a) | **R. 91** — purchaser's application on the ground of no saleable interest; or a suit | **Article 127 — sixty days** for R. 91 | R. 91 application, or a title suit |
| Multiple decree-holders and one fund | **s. 73** with O. XXI R. 52 | Rateable distribution among those who applied before receipt of assets | Application before receipt | Application for rateable distribution |

::: info Fee and practice note — what an attachment actually costs, and who bears it
Attachment is fee-light but cost-heavy, and the costs fall on the decree-holder before any recovery:

1. **Process fee and bailiff's batta** for the warrant, and for the beat of drum and affixture under Rule 54(2). Where the property is in another district, the cost of transmission under Rule 24.
2. **Custody charges** for seized movables under Rule 43A — where a vehicle or machinery is seized, the court will require the decree-holder to fund a godown or a watchman, and the sums are substantial. Consider whether a Rule 46 prohibitory order on the registering authority achieves the same protective effect at no cost.
3. **Publication** in the Official Gazette or a local newspaper where the court directs it under Rule 54(3), and again for the proclamation under Rule 67.
4. **A claim petition under Rule 58** is presented on a **fixed court fee** as a miscellaneous application — it is not valued on the market value of the property, because it is an application in execution and not a suit for declaration. But note the corollary: the **appeal** against a Rule 58 order, being an appeal from a deemed decree, is valued in most States on the value of the subject matter, which can be a very unpleasant surprise for a claimant who lost.
...
**Ratio decidendi:** An agreement to sell creates no interest in the property, but it creates an obligation annexed to the ownership, and a transferee in pursuance of a **prior agreement** obtains an equity superior to that of the attaching creditor, since the attaching creditor can attach only that right, title and interest which the judgment-debtor possessed at the date of attachment — which was already burdened by the obligation to convey.
...
*Facts:* Whether a third party in possession could be dealt with under Rules 97 to 101, and the relationship between adjudication in execution and a separate suit.

**Ratio decidendi:** After the 1976 amendment, the executing court has jurisdiction to decide **all questions**, including questions of title, arising between the parties to the proceeding; the object of the amendment was to eliminate multiplicity and to end the practice of relegating obstructors and claimants to independent suits. The adjudication has the force of a decree.

::: tip Practitioner Takeaway
"The 1976 amendments to Order XXI were designed to ensure that all questions, including questions of right, title and interest, arising in execution are determined by the executing court itself and not by a separate suit; this Hon'ble Court is therefore bound to try the present claim on the merits, and the objection that the claimant should be relegated to a title suit is contrary to Rule 58(2) and to *Silverline Forum*."
:::

**Bhurey Khan v. Yaseen Khan, (1995) 5 SCC 41** — 2-Judge Bench.
*Facts:* An execution application was dismissed and the court gave no direction as to the continuance of the attachment.

**Ratio decidendi:** Rule 57 as substituted in 1976 requires the court, on dismissing an execution application, to state whether the attachment shall continue or cease and to fix the period; where the court omits to give such a direction, sub-rule (2) operates and the attachment is **deemed to have ceased** by force of the statute. No subsequent order can retrospectively revive it to the prejudice of an intervening transferee.

::: tip Practitioner Takeaway
"By operation of Order XXI Rule 57(2), the attachment ceased on the dismissal of the execution application dated [•], no direction as to its continuance having been recorded; the transfer effected thereafter is consequently outside section 64 altogether, and the objection that it is void must fail."
:::

**Desh Bandhu Gupta v. N.L. Anand, (1994) 1 SCC 131** — 2-Judge Bench.
*Facts:* Concerned obstruction and the scope of the executing court's power to decide questions of title raised by strangers.

**Ratio decidendi:** The scheme of the amended Order XXI is that the executing court determines the rights of all persons who resist or claim, and the determination is a decree; the court must, however, distinguish between a person claiming **through** the judgment-debtor — who is bound and whose resistance is disposed of summarily — and a person claiming an **independent** right, whose claim must be tried.

::: tip Practitioner Takeaway
"The decisive question under Order XXI is whether the objector claims through the judgment-debtor or in his own independent right; the objector here holds under a lease granted by the judgment-debtor after the institution of the suit and is therefore a transferee *pendente lite* bound by the decree under section 52 of the Transfer of Property Act, and his obstruction must be removed without trial."
:::
...
2. **Attaching exempt property.** Salary below the section 60 floor, provident fund, gratuity, life-insurance monies, a right to future maintenance, an agriculturist's implements and occupied house. These attachments are set aside with costs and destroy the decree-holder's credibility for the rest of the execution.
3. **Letting an attachment die under Rule 57(2).** The most expensive omission in execution practice. Every dismissal of an EA — including a dismissal "with liberty to file afresh" — requires an express direction continuing the attachment, stating the period. Diarise it.
4. **Filing a Rule 58 claim without a Rule 59 application.** If the property is sold while the claim is pending, proviso (a) to Rule 58(1) bars the claim itself. The two applications must be filed together, in the same breath, and pressed on the same day.
5. **Relying on an unregistered agreement to sell against an attachment.** Section 64(2) protects only a contract "entered into **and registered** before the attachment". After the 2001 amendment to section 53A of the Transfer of Property Act, an unregistered agreement will not even support part performance.
6. **Filing a revision against a Rule 58 order.** The order is deemed a decree under Rule 58(4). The remedy is a **first appeal under section 96**, and by the time a wrongly-filed revision is dismissed, the appeal is time-barred. This is the single most common procedural casualty in this block.
7. **Attaching without checking for a moratorium.** Section 14 of the IBC (corporate debtor) and section 96 (personal guarantor) prohibit execution absolutely. An attachment made during a moratorium is void and exposes the decree-holder to costs.
:::

::: warning Strategic timing — the attachment calendar
**Day 30 — apply under Rule 41(2).** The thirty-day trigger is the earliest coercive step available and it costs nothing. Ask in the same application for a warning in the order that a false affidavit will attract a complaint under section 379 of the BNSS, 2023.

**Immediately on attaching immovable property — verify the four publicity steps.** Beat of drum on or adjacent to the property; affixture on the property; affixture on the court-house; copy to the Collector for revenue land and to the Gram Panchayat for village land. Take photographs of the affixture with a date stamp and file them. Rule 54(4) means that the *affixture date*, not the order date, governs against a bona fide purchaser, and the only proof you will have three years later is what you filed.

**Before you attach, search.** Encumbrance certificate, CERSAI, the RoC charge register for a corporate debtor, and the IBC portal. An attachment behind a registered mortgage realises nothing, and the sale will still cost you the proclamation expenses.

**For the claimant — move within days, not weeks.** Proviso (b) to Rule 58(1) is a delay bar, and the claimant's own conduct is the first thing the court examines. File the claim and the Rule 59 application together; annex a chronology showing the date of knowledge; and if the sale is imminent, ask in the alternative for the Rule 59(b) order that the property may be sold but the sale shall not be confirmed — courts grant that far more readily than a stay of sale, and it fully protects you.

**For the judgment-debtor — Rule 55 is a complete answer, and it is self-executing.** If the decretal amount with costs and attachment charges is deposited, the attachment is "deemed to be withdrawn" without any order. Deposit first, apply afterwards.
:::

**Model prayer — application under Order XXI Rule 41(2) for an affidavit of assets**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** direct the judgment-debtor to file, within two weeks, an affidavit under Order XXI Rule 41(2) disclosing the particulars of all his assets, whether movable or immovable, held in his own name or in the name of any other person on his behalf, including bank accounts, demat holdings, insurance policies, receivables, and interests in any firm or company, together with all transfers effected by him since the institution of the suit;
>
> **(b)** direct the judgment-debtor to appear in person for oral examination under Order XXI Rule 41(1) on the said affidavit;
>
> **(c)** summon the Manager, [bank], under Order XVI Rule 6 to produce the statements of Account No. [•] for the period [•] to [•];
>
> **(d)** record that in the event of disobedience of the order at prayer (a), this Hon'ble Court shall be at liberty to proceed under Order XXI Rule 41(3); and
>
> **(e)** pass such further order as may be just.

**Model prayer — claim petition under Order XXI Rule 58 with a Rule 59 application**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** adjudicate upon this claim under Order XXI Rule 58(1) and determine, under sub-rule (2), all questions relating to the right, title and interest of the claimant in the property described in the Schedule;
>
> **(b)** hold that the said property was, on the date of attachment, in the possession and enjoyment of the claimant on his own account and was not liable to attachment in execution of the decree in [suit number], and accordingly release the same from attachment under Rule 58(3)(a);
>
> **(c)** **pending adjudication of this claim, order under Order XXI Rule 59(b) that the said property shall not be sold; or in the alternative, that if sold, the sale shall not be confirmed**;
>
> **(d)** award the claimant the costs of this petition; and
>
> **(e)** pass such further order as may be just.

| # | Checklist — attachment and claims | Provision |
|---|---|---|
| 1 | Species of property identified and the correct mode of attachment selected | RR. 43–54 |
| 2 | Section 60 exemptions checked; salary computation done | s. 60 proviso, s. 60(1A) |
| 3 | Encumbrance, CERSAI, RoC charges and IBC moratorium searched before attaching | SARFAESI; IBC ss. 14, 96 |
| 4 | R. 54 order obtained; beat of drum, affixture on property and court-house, Collector/Panchayat copies effected and photographed | O. XXI R. 54(2) |
| 5 | Where directed — gazette or newspaper publication effected | O. XXI R. 54(3) |
| 6 | Garnishee notices issued to banks, employers and identifiable debtors | O. XXI RR. 46A–46I |
| 7 | Every EA dismissal followed by an express R. 57(1) continuation direction | O. XXI R. 57 |
| 8 | Claim petition — filed promptly, with a chronology of knowledge | O. XXI R. 58 proviso (b) |
| 9 | Rule 59 application filed **with** the claim, never after | O. XXI R. 59 |
| 10 | Reliance on a pre-attachment agreement — confirm it is **registered** | s. 64(2) |
| 11 | Against an adverse R. 58 order — first appeal under s. 96, not revision | O. XXI R. 58(4) |
| 12 | Costs of attachment quantified and claimed for taxation | s. 35, O. XXI R. 74 |
...
| Operative expression | Character | Consequence |
|---|---|---|
| R. 64 "**or such portion thereof as may seem necessary** to satisfy the decree" | **Mandatory limitation on the power** | Selling an entire estate to realise a small decree is an excess of jurisdiction; the court must consider whether a part suffices |
| R. 66(2) "shall… specify **as fairly and accurately as possible**" the five particulars | **Mandatory in substance** | An inaccurate or silent proclamation is the classic "material irregularity in publishing" under R. 90 |
| R. 66(2)(c) "**any encumbrance** to which the property is liable" | **Mandatory disclosure** | Concealment of a mortgage depresses or inflates bids and is a ground both under R. 90 and, for the purchaser, under R. 91 |
| R. 66 second proviso — court need not enter **its own** estimate of value | Prohibitory in form | The court must record the parties' estimates but must not adjudicate value at this stage; both estimates go in |
| R. 68 "**shall not, without the consent in writing** of the judgment-debtor, take place until… **fifteen days** / **seven days**" | **Mandatory minimum interval** | Computed from **affixture on the court-house**; a sale held early is a material irregularity |
| R. 72(1) "**No** holder of a decree… shall, without the **express permission** of the Court, bid for or purchase" | **Prohibitory** | R. 72(3) — sale liable to be set aside on application, with the deficiency on re-sale charged to the decree-holder |
| R. 72A mortgagee — "**shall not bid**… unless the Court grants him leave" | **Prohibitory** | Prevents a mortgagee buying in the equity of redemption cheaply at his own sale |
| R. 73 "**No officer** or other person having any duty… shall… bid, acquire or attempt to acquire" | **Absolute prohibition** | No permission is possible; a purchase in breach is void, not voidable |
| R. 84(1) "**shall pay immediately**… twenty-five per cent… in default… **forthwith be re-sold**" | **Mandatory, immediate** | "Immediately" means at the fall of the hammer; the court has no power to extend |
| R. 85 "**before the Court closes on the fifteenth day** from the sale" | **Mandatory** | The period is fixed by the rule and is not extendable; s. 148 does not apply to enlarge it |
| R. 86 deposit "may… be **forfeited** to the Government" and "the defaulting purchaser shall **forfeit all claim**" | Penal | Default costs the purchaser the 25 per cent and any right to the property |
| R. 89(1) "**any person claiming an interest** in the property sold" | **Wide standing** | Not confined to the judgment-debtor — a co-owner, a mortgagee, a legal representative or a subsequent purchaser may deposit and redeem |
| R. 89(1)(a)–(b) — **5 per cent** to the purchaser **plus** the proclaimed decretal sum | **Cumulative condition precedent** | A deposit short of either limb, however marginally, defeats the application |
| R. 89(2) — cannot prosecute R. 89 and R. 90 together | **Election** | The applicant must withdraw the R. 90 application before proceeding under R. 89 |
| R. 90(2) "**unless… the applicant has sustained substantial injury** by reason of such irregularity or fraud" | **Twin condition** | Irregularity alone is never enough; the causal link between irregularity and injury (usually depressed price) must be proved |
| R. 90(3) — no ground "which the applicant **could have taken on or before**" the settling of the proclamation | **Preclusion** | Objections to valuation, encumbrances or the extent of property must be taken at the R. 66 stage or they are lost |
| R. 90 *Explanation* — "mere absence of, or defect in, **attachment**… shall not by itself be a ground" | Clarificatory (1976) | Overrules the earlier view that a defective attachment vitiated the sale |
| R. 91 "the judgment-debtor **had no saleable interest**" | Purchaser's remedy only | The decree-holder and the judgment-debtor cannot invoke it |
| R. 92(1) "the Court **shall** make an order confirming the sale, and thereupon the sale **shall become absolute**" | **Mandatory once the windows close** | Confirmation is not discretionary; but until it is made, the sale is inchoate |
| R. 92(3) "**No suit** to set aside an order made under this rule shall be brought" | **Bar on suits** | The remedy against a R. 92 order is appeal under O. XLIII R. 1(j), not a suit |
| **s. 65** property "deemed to have **vested in the purchaser from the time when the property is sold**" | **Relation back** | Title relates back to the auction date, not the confirmation date — decisive for mesne profits and for intervening transfers |

::: warning The conceptual hinge — three windows, one confirmation, and the doctrine of relation back
A court sale is not complete when the hammer falls. Between the auction and the vesting of an indefeasible title lie three statutory windows, and the sale is inchoate until all of them have closed:

- **Rule 89** — anyone with an interest may buy the sale off by depositing five per cent for the purchaser plus the proclaimed decretal amount. This is a redemption right, and it does not require any fault in the sale.
- **Rule 90** — the judgment-debtor, the decree-holder, the purchaser or anyone whose interests are affected may attack the sale for **material irregularity or fraud in publishing or conducting it**, but only on proof of **substantial injury**, and only on grounds not available at the proclamation stage.
- **Rule 91** — the purchaser alone may escape on the ground that the judgment-debtor had **no saleable interest**.

The limitation for all three is **Article 127 of the Limitation Act — sixty days from the date of the sale** (reduced from thirty by the 1976 amendment for Rules 89 and 90). When the windows close, or the applications are dismissed, Rule 92(1) obliges the court to confirm, and the sale becomes absolute.
...
**(b) The proclamation is the single most important document in a court sale.** Rule 66(2) requires it to state, "as fairly and accurately as possible", the property, the revenue assessed, **any encumbrance**, the amount for which the sale is ordered, and everything material for a purchaser to judge the nature and value of the property. Its function is to produce an informed market. An inaccurate proclamation produces a depressed price, and a depressed price is the "substantial injury" that Rule 90 requires — which is why nearly every successful Rule 90 application is in substance an attack on the proclamation.

**(c) The court does not value the property — it records the parties' valuations.** The second proviso to Rule 66(2) is explicit: nothing requires the court to enter **its own** estimate, but the proclamation "shall include the estimate, if any, given by either or both of the parties". So both sides file valuations and both go into the proclamation. The judgment-debtor who does not file a valuation at the settling of terms has, by Rule 90(3), lost the right to complain later that the property fetched too little — because that was a ground he could have taken on or before the date the proclamation was drawn up.

**(d) Rule 68's interval is measured from affixture on the court-house, not from the proclamation order.** Fifteen days for immovables, seven for movables, and it may be shortened only by the judgment-debtor's **written** consent. The purpose is to give the market notice. Sales held on the fourteenth day are set aside routinely — and the date of affixture is a fact that has to be proved from the record, which is why the affixture endorsement matters so much.

**(e) Rules 72, 72A and 73 police who may buy.** A decree-holder may not bid without the **express permission** of the court — because he sets the reserve, controls the information and can set off his decree against the price, and so has an unfair advantage. If he does buy without permission, Rule 72(3) allows the sale to be set aside on application, and makes him liable for the shortfall on re-sale. A mortgagee needs leave under Rule 72A even in execution of his own mortgage decree. And Rule 73 imposes an **absolute** bar on any officer connected with the sale — no permission can cure it, because the vice is the conflict itself.

**(f) The purchaser's obligations are two, and both are unforgiving.** Twenty-five per cent **immediately** on being declared the purchaser (Rule 84) — meaning at the fall of the hammer, not by the end of the day. The balance **before the court closes on the fifteenth day** (Rule 85). Neither period is extendable: the Supreme Court has held that section 148, which permits enlargement of time fixed *by the court*, has no application to a period fixed *by the rule itself*. On default, Rule 86 permits forfeiture of the deposit to the Government and a re-sale, and the defaulting purchaser forfeits all claim to the property and to any part of the price it later fetches.

**(g) Rule 89 is a redemption right, and it is far wider than the judgment-debtor.** "Any person claiming an interest in the property sold at the time of the sale **or at the time of making the application**" may deposit and have the sale set aside. That includes a co-sharer, a mortgagee, a legal representative, and — importantly — a person who bought from the judgment-debtor after the sale. The deposit is cumulative: five per cent of the purchase-money for the purchaser (his solatium for losing the bargain) **plus** the decretal amount as specified in the proclamation, less any post-proclamation receipts. A deposit that is short by any margin fails, subject only to the court's power under Rule 92(2) to allow correction of a **clerical or arithmetical** deficiency.

**(h) Rule 90 is a two-stage burden, and applicants routinely discharge only the first.** Stage one: prove a **material irregularity or fraud in publishing or conducting** the sale — a defective proclamation, non-disclosure of an encumbrance, a short interval under Rule 68, failure to affix, a sale of the whole where a part would do. Stage two: prove **substantial injury by reason of** that irregularity. Both a causal connection and a quantified loss are required. The usual proof is a valuation report plus comparable sale instances showing the market value against the auction price, coupled with evidence that bidders stayed away because of the defect complained of.

**(i) Two limits on Rule 90 do most of the work of defeating it.** Sub-rule (3) precludes any ground the applicant **could have taken on or before the settling of the proclamation** — which forecloses complaints about undervaluation, extent, or undisclosed encumbrances if the applicant participated in or was noticed for the Rule 66 hearing. And the *Explanation*, added in 1976, provides that the mere absence of or defect in the **attachment** is not by itself a ground — reversing a large body of earlier case law and closing the most popular technical challenge.

**(j) Rule 91 belongs to the purchaser alone, and it is his protection against buying a lawsuit.** If the judgment-debtor had no saleable interest — the property belonged to a third party, or the debtor's interest was a mere licence, or the sale was of a co-parcener's undivided share described as the whole — the purchaser may have the sale set aside and his money returned. He must move within **sixty days under Article 127**. A purchaser who discovers the defect late, or who takes the certificate and then sues for possession, will find he has neither the property nor a refund.

**(k) Confirmation under Rule 92 is ministerial, and it is the point of no return.** Once the applications are disposed of or the period expires, the court "shall" confirm. Rule 92(3) then bars any **suit** to set aside the confirmation order; the remedy is an appeal, confirmation being an appealable order under Order XLIII Rule 1(j). After confirmation, Rule 94 issues the sale certificate, dated the day the sale became absolute, and Rule 95 entitles the purchaser to delivery against the judgment-debtor, anyone holding on his behalf, and any person claiming under a title created by the debtor **after the attachment**.
...
| Trigger | Provision | Interlocking Order/Rule | Limitation / fee | Application to file |
|---|---|---|---|---|
| Attached property to be brought to sale | O. XXI R. 64 | R. 54(1A) notice to attend for settling terms | — | Application for an order of sale, with the R. 66(3) verified statement |
| Terms of the proclamation to be settled | **O. XXI R. 66(2)** | R. 54(1A); R. 90(3) preclusion | — | Both parties file valuation statements; **attend or lose the ground** |
| Proclamation to be published | O. XXI R. 67 with R. 54(2) | R. 67(2) gazette/newspaper; costs are costs of the sale | — | Application for newspaper publication where the value is substantial |
| Sale to be held | O. XXI R. 68 | Fifteen days (immovable) / seven days (movable) from **court-house affixture** | Written consent of the judgment-debtor to shorten | — |
| Decree-holder wishes to bid | **O. XXI R. 72(1)** | R. 72(2) set-off of the decree against the price, subject to **s. 73** | Permission must precede the sale | Application for express permission to bid, stating the intended maximum |
| Mortgagee wishes to bid at his own mortgage sale | O. XXI R. 72A | O. XXXIV RR. 4–5 (mortgage decrees) | — | Application for leave |
| Purchaser declared | O. XXI R. 84 | **25 per cent immediately**, else forthwith re-sold | Immediate — not extendable | — |
| Balance purchase-money | **O. XXI R. 85** | R. 86 forfeiture and re-sale; **s. 148 does not enlarge** a period fixed by the rule | Before the court closes on the **15th day** | — |
| Anyone with an interest wants to buy off the sale | **O. XXI R. 89** | R. 89(2) — must withdraw any R. 90 application; R. 92(2) correction of clerical deficiency | **Article 127 — sixty days** from the sale | Application with the deposit **already made**: 5 % to the purchaser + proclaimed decretal sum |
| Irregularity or fraud in publishing or conducting the sale | **O. XXI R. 90** | R. 90(2) substantial injury; R. 90(3) preclusion; *Explanation* on attachment defects | **Article 127 — sixty days** | Application with a valuation report and comparable sales |
| Judgment-debtor had no saleable interest | O. XXI R. 91 | s. 65 vesting; *caveat emptor* at court sales | **Article 127 — sixty days** | Application by the **purchaser only** |
| Applications disposed of or period expired | **O. XXI R. 92(1)** | Sale becomes absolute; **s. 65** relation back to the sale date | — | Court confirms; obtain a certified copy of the confirmation order |
| Order under R. 92 to be challenged | R. 92(3) — **no suit** | **O. XLIII R. 1(j)** — appeal from an order under R. 92 setting aside or refusing to set aside a sale | **Article 116/117** — 90 or 30 days | Miscellaneous first appeal |
| Sale absolute; purchaser wants his title document | O. XXI R. 94 | **Indian Stamp Act Sch. I Art. 18** — duty as on a conveyance; **Registration Act s. 89(4)** — court sends a copy to the Sub-Registrar | Stamp payable on issue | Application for the sale certificate |
| Purchaser wants possession from the debtor or his post-attachment transferee | **O. XXI R. 95** | s. 52 TPA *lis pendens* | **Article 134 — one year** from when the sale becomes absolute | Application for delivery of possession |
| Purchaser resisted by a stranger | O. XXI R. 95 fails → **R. 97** | RR. 97–106 adjudication | **Article 129 — thirty days** from resistance | R. 97 application |
| Multiple decree-holders claiming the sale proceeds | **s. 73** with O. XXI R. 74–76 | Rateable distribution; costs of the sale come off the top | Application before receipt of assets | Application for rateable distribution |

::: info Fee, stamp and registration — the sale certificate is not free
Three financial consequences follow a court sale, and the auction-purchaser who has not budgeted for them will try to escape the purchase:

1. **Stamp duty on the sale certificate.** A certificate under Rule 94 is chargeable under **Article 18 of Schedule I to the Indian Stamp Act, 1899** as a conveyance, on the price or the market value as determined by the State's valuation rules, whichever is higher. It is a substantial addition to the bid — commonly five to seven per cent — and it is payable by the purchaser.
2. **Registration.** A sale certificate granted by a court is exempt from compulsory registration under **section 17(2)(xii) of the Registration Act, 1908**, but **section 89(4)** requires the court to forward a copy to the registering officer for filing in Book No. 1. Purchasers should nonetheless obtain the filing endorsement — mutation authorities routinely ask for it.
3. **Costs of the sale come off the top.** Under Rule 74 and section 73, the expenses of the sale — proclamation, publication, commission and establishment charges — are defrayed from the proceeds before the decretal amount is paid. A decree-holder who spent ₹1.8 lakh on publication recovers it in priority, but only if the expenditure is on the record and quantified in an application.
...
**Ratio decidendi:** The provisions of Rules 84, 85 and 86 are **mandatory**. Where the purchaser fails to deposit the balance within the prescribed period, there is **no sale at all** in the eye of law; the court has no discretion to extend the time, and section 148 of the Code, which permits enlargement of a period fixed *by the court*, has no application to a period fixed *by the rule*. The consequence follows automatically: the deposit may be forfeited and the property must be re-sold.
...
*Facts:* A judgment-debtor complained that his property had been knocked down at a court auction far below its valuation.

**Ratio decidendi:** An executing court is not to be a "helpless spectator" of a scandalously low bid, but nor can it postpone the sale indefinitely in the hope of a better price. A court sale is a forced sale, and the price it fetches will realistically be below the open-market figure; the court's duty is to see that the sale is fairly conducted and adequately publicised, not to guarantee the market value. Mere inadequacy of price is therefore not by itself a ground under Rule 90.

::: tip Practitioner Takeaway
"As held in *Kayjay Industries*, a court sale is a forced sale and mere inadequacy of the price fetched is not, without more, a material irregularity within Order XXI Rule 90; the objector must identify the irregularity in publishing or conducting the sale and connect it to the price, which he has wholly failed to do."
:::

**Ashwin S. Mehta v. Custodian, (2006) 2 SCC 385** — 2-Judge Bench.
*Facts:* Concerned the rights of an auction-purchaser where the underlying decree or order was subsequently varied.

**Ratio decidendi:** The rights of a bona fide auction-purchaser who is a stranger to the decree are protected, and the sale in his favour will not ordinarily be disturbed merely because the decree is subsequently set aside; the judgment-debtor's remedy in such a case is restitution under **section 144** against the decree-holder for the sale proceeds, not the recovery of the property from the purchaser. The position is otherwise where the purchaser is the decree-holder himself.

::: tip Practitioner Takeaway
"Where the auction-purchaser is a bona fide stranger to the decree, the reversal of the decree does not disturb his title; the judgment-debtor's remedy lies in restitution under section 144 of the Code against the decree-holder for the sale proceeds with interest — and it is only where the decree-holder is himself the purchaser that the sale falls with the decree."
:::

**Gurpreet Singh v. Union of India, (2006) 8 SCC 457** — Constitution Bench (5 Judges).
*Facts:* The order in which payments made in execution are to be appropriated between principal, interest and costs.

**Ratio decidendi:** In execution of a money decree, in the absence of a contrary direction in the decree, payments are appropriated **first towards costs, then towards interest, and last towards principal** — but interest ceases to run on the principal to the extent of any deposit made, from the date of the deposit. The Court also clarified the operation of section 73 and the rateable distribution of assets among decree-holders who had applied before the assets were received.

::: tip Practitioner Takeaway
"Under the rule settled by the Constitution Bench in *Gurpreet Singh v. Union of India*, deposits in execution are appropriated first to costs, then to interest, and thereafter to principal, and interest ceases to run on so much of the principal as stands deposited from the date of deposit; the decree-holder's computation, which applies the entire deposit to interest and continues to charge interest on the undiminished principal, is contrary to that rule."
:::
...
2. **Filing no valuation at the Rule 66 stage.** The second proviso requires the proclamation to include the parties' estimates. If the judgment-debtor files none, the proclamation goes out with the decree-holder's figure alone, the market prices off it, and the debtor cannot complain.
3. **Leaving the encumbrance column blank.** For the decree-holder this is the most dangerous omission in the whole Order: it grounds a Rule 90 application by the debtor *and* a Rule 91 or Rule 90 application by the purchaser, and it can unwind a completed sale two years later.
4. **Bidding as decree-holder without express permission.** Rule 72(3) makes the sale liable to be set aside and puts the shortfall on re-sale on the decree-holder. Permission is a two-line application; the omission is routinely fatal.
5. **Missing the Rule 84 or Rule 85 deposit.** Twenty-five per cent at the fall of the hammer, the balance by close of the fifteenth day. No extension exists. Purchasers who arrange finance after winning the bid lose the deposit under Rule 86.
6. **Running Rule 89 and Rule 90 in parallel.** Sub-rule (2) of Rule 89 forbids it. Elect: if the property is worth saving, deposit under Rule 89 and withdraw the Rule 90 application; if the sale is genuinely tainted and there is no money to deposit, prosecute Rule 90 alone.
7. **Depositing a rupee short under Rule 89.** Five per cent of the **purchase-money** (not the reserve, not the valuation) plus the amount specified **in the proclamation**, less post-proclamation receipts. Annex the arithmetic. Only clerical or arithmetical deficiencies can be cured under Rule 92(2).
8. **Filing a suit to set aside a confirmation order.** Rule 92(3) bars it absolutely. The remedy is an appeal under Order XLIII Rule 1(j).
:::

::: warning Strategic timing — the sale calendar, both sides
**For the decree-holder.** Get the Rule 54(1A) notice served and proved — it is what makes Rule 90(3) available to you later. File a verified Rule 66(3) statement with an independent valuer's report and a fresh encumbrance certificate; over-disclose, because every disclosure is a brick in the wall against a future Rule 90. Ask for newspaper publication under Rule 67(2) whenever the property is worth more than about ten times the publication cost — it raises the price, and its absence is the first thing an objector points to. Apply for permission to bid **before** the auction, even if you do not intend to use it; it costs nothing and it prevents the failed-auction problem.

**For the judgment-debtor.** Your case is won or lost at the proclamation stage, sixty days before the auction. Appear on the Rule 54(1A) date; file a registered valuer's report; insist that the conversion status, frontage, encumbrances and any pending acquisition award go into the proclamation; and ask under **Rule 64** that only such portion of the property be sold as is necessary to satisfy the decree — this is the most under-used protection in the Order and it is a complete answer where a large holding is being sold for a small decree.

**After the sale, the clock is sixty days for everything.** Article 127 governs Rules 89, 90 and 91 alike. Decide within the first week which route you are taking, because Rule 89 requires the money to be **in court** when the application is made, and arranging a deposit of five per cent plus the decretal amount takes time.

**For the purchaser.** Inspect before you bid — *caveat emptor* governs court sales and Rule 91 is available only where there was **no** saleable interest at all, not where the interest was partial or encumbered. Budget for stamp duty on the certificate. And if possession is resisted after confirmation, note two different clocks: **Article 134 — one year** to apply for delivery under Rule 95, and **Article 129 — thirty days** to complain of resistance under Rule 97.
:::

**Model prayer — objection at the settling of the terms of the proclamation (Rule 66)**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** settle the terms of the proclamation of sale so as to describe the property as **converted non-agricultural commercial land** vide conversion order dated [•], with a frontage of [•] feet on [road], and to record the valuation of ₹[•] as per the report of [registered valuer] annexed hereto as Annexure A;
>
> **(b)** direct that the proclamation disclose, in terms of Order XXI Rule 66(2)(c), the mortgage in favour of [bank] registered on [date] and the pending acquisition proceedings in [reference];
>
> **(c)** direct, in exercise of the power under **Order XXI Rule 64**, that only such portion of the property as is necessary to satisfy the decretal sum of ₹[•] — namely the eastern [•] square metres shown hatched in the plan at Annexure B — be brought to sale, and that the remainder be released from attachment;
>
> **(d)** direct publication of the proclamation in [newspaper] under Order XXI Rule 67(2); and
>
> **(e)** pass such further order as may be just.

**Model prayer — application under Order XXI Rule 90**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** set aside the sale of the property described in the Schedule held on [date] in Execution Petition No. [•], on the ground of material irregularity and fraud in publishing and conducting the said sale, particularised in paragraphs [•] to [•] above;
>
> **(b)** hold that by reason of the said irregularities the applicant has sustained substantial injury within the meaning of Order XXI Rule 90(2), the property of a market value of ₹[•] as per the valuation report at Annexure A having been knocked down for ₹[•];
>
> **(c)** direct a fresh proclamation and re-sale in accordance with law after settling the terms afresh under Order XXI Rule 66; and
>
> **(d)** pending disposal of this application, restrain the confirmation of the said sale under Order XXI Rule 92.

| # | Checklist — before, at and after a court sale | Provision |
|---|---|---|
| 1 | R. 54(1A) notice served on the judgment-debtor and proof filed | O. XXI R. 54(1A) |
| 2 | Verified R. 66(3) statement filed with valuation and encumbrance certificate | O. XXI R. 66(3) |
| 3 | Proclamation checked against all five clauses of R. 66(2) — especially encumbrances | O. XXI R. 66(2) |
| 4 | Both parties' valuation estimates recorded in the proclamation | O. XXI R. 66, 2nd proviso |
| 5 | R. 64 "such portion as is necessary" considered and the order recorded | O. XXI R. 64 |
| 6 | Proclamation published per R. 54(2); gazette/newspaper where directed | O. XXI R. 67 |
| 7 | Court-house affixture date endorsed; fifteen / seven day interval computed | O. XXI R. 68 |
| 8 | Decree-holder's permission to bid obtained **before** the auction | O. XXI R. 72(1) |
| 9 | 25 per cent taken at the fall of the hammer; receipt on record | O. XXI R. 84 |
| 10 | Balance deposited before close of the fifteenth day | O. XXI R. 85 |
| 11 | Sixty-day Article 127 window diarised for RR. 89, 90 and 91 | Art. 127, Limitation Act |
| 12 | R. 89 deposit arithmetic annexed; R. 90 application withdrawn if R. 89 is pursued | O. XXI R. 89(1), (2) |
| 13 | Confirmation order under R. 92 obtained in certified copy | O. XXI R. 92(1) |
| 14 | Sale certificate applied for; stamp duty paid; s. 89(4) Registration Act copy sent | O. XXI R. 94 |
| 15 | Delivery applied for within one year; resistance complained of within thirty days | Arts. 134, 129 |
...
| Operative expression | Character | Consequence |
|---|---|---|
| R. 97(1) "resisted or obstructed by **any person**" | **Deliberately unqualified** (1976) | The pre-1976 distinction between obstruction by the judgment-debtor and by a stranger is abolished; every obstructor is dealt with here |
| R. 97(2) "the Court **shall proceed to adjudicate**" | **Mandatory** | No discretion to relegate the parties to a suit; the executing court must try the matter |
| R. 98(2) "resistance… **without any just cause** by the judgment-debtor or… at his instigation… or by any transferee… **during the pendency of the suit or execution**" | Conditional; penal | Delivery is directed, and continued obstruction may be met with **detention up to thirty days** |
| R. 99(1) "**any person other than the judgment-debtor** is dispossessed" | Restitutionary | A stranger physically dispossessed by the decree-holder or the auction-purchaser gets a remedy in execution rather than a suit for possession |
| **R. 101** "**All questions (including questions relating to right, title or interest)**… shall be determined by the Court… **and not by a separate suit**" | **Exclusionary + jurisdiction-conferring** | The "notwithstanding anything to the contrary in any other law" clause overrides pecuniary and subject-matter limits — a Munsif's court may decide a title question worth crores |
| R. 101 "shall be **deemed to have jurisdiction**" | **Deeming, non-obstante** | Removes the objection that the executing court lacks jurisdiction to try title |
| **R. 102** "**Nothing in rules 98 and 100 shall apply**" to a transferee *pendente lite* | **Exclusionary bar** | A person who bought from the judgment-debtor after the suit was filed has **no** remedy under RR. 98/100 — he is bound by s. 52 TPA and is simply removed |
| R. 102 *Explanation* — "transfer includes a transfer **by operation of law**" | Extending | Court sales, devolution and statutory vesting during the suit are equally caught |
| **R. 103** order "shall have the **same force**… as if it were a **decree**" | Deeming | Appealable as a decree under **s. 96**; no revision under s. 115 and no O. XLIII appeal |
| R. 104 order "shall be **subject to the result of any suit** pending on the date of commencement of the proceeding" | Saving | A pre-existing title suit is preserved and prevails; but a suit filed **after** the R. 97 proceeding began is not saved |
| R. 105(2) applicant absent — "the Court **may** make an order that the application be dismissed" | Enabling | Dismissal for default; curable under R. 106 |
| R. 105(3) opposite party absent — court "may hear the application **ex parte**" | Enabling | Mirrors O. IX in the execution context |
| R. 105 *Explanation* — includes "a claim or objection made under **rule 58**" | Extending | RR. 105–106 govern the conduct of Rule 58 claims as well |
| **R. 106(3)** "within **thirty days** from the date of the order, or… from the date when the applicant had **knowledge**" | **Mandatory period** | Self-contained limitation; the knowledge extension applies only where notice was not duly served |
| **Article 129, Limitation Act** — thirty days to complain of resistance | External limitation | Runs from the **date of resistance or obstruction**, not from the decree or the sale |

::: warning The conceptual hinge — Rules 97 to 106 are a suit inside the execution
Before 1976 the position was intolerable. If the decree-holder was obstructed by a stranger, the executing court held a summary enquiry, and whichever side lost had a year in which to file a regular suit to establish its right. The result was that every contested delivery of possession generated a second round of litigation lasting a decade.

The 1976 amendment replaced that scheme with a **complete adjudicatory code**. Three provisions do the work:

- **Rule 97(1)** — obstruction "by **any person**" is complained of to the executing court; the old distinction between the judgment-debtor's obstruction and a stranger's disappears.
- **Rule 101** — the executing court determines **all questions including title**, "and not by a separate suit", and is "**deemed to have jurisdiction**" to do so notwithstanding any other law. That deeming clause is essential: without it, a court of limited pecuniary jurisdiction could not try a title dispute over property far above its ordinary limits.
- **Rule 103** — the resulting order **is a decree**, appealable as such under section 96.

So the modern position is that a contested delivery of possession is tried as a suit, in the executing court, with issues, evidence and a decree, and the appeal from it is a first appeal. The proceeding is not summary and cannot be disposed of on affidavits over the objection of a party.
...
**(b) The decisive question in every case is: does the obstructor claim *through* the judgment-debtor, or *independently* of him?** If through — a family member, an employee, a licensee, a benamidar, or a transferee *pendente lite* — the obstruction is "without just cause" under Rule 98(2), delivery is directed, and continued obstruction can attract **thirty days in civil prison**. If independently — a prior tenant, a co-owner never impleaded, a person in adverse possession since before the suit, a prior mortgagee in possession — then Rule 101 requires his claim to be **tried**, with issues and evidence, and the executing court must decide it as a court of first instance.

**(c) Rule 102 removes the transferee *pendente lite* from the scheme altogether.** It says "nothing in rules 98 and 100 shall apply" to such a person. The *Explanation* extends "transfer" to transfers **by operation of law**, so devolution and statutory vesting during the suit are equally caught. The rationale is section 52 of the Transfer of Property Act: a transfer during the pendency of a suit does not affect the rights of the other party under the decree. Practically, the first document to look for when an obstructor appears is the date of his title deed against the date of institution of the suit; that single comparison usually decides the whole application.

**(d) Rule 101's non-obstante clause solves a jurisdictional puzzle.** A civil judge (junior division) with a pecuniary limit of, say, ₹10 lakh may be executing a decree for possession of property worth ₹8 crore, and an obstructor may raise a title claim of that value. Ordinarily that court could not try such a claim. Rule 101 says it is "**deemed to have jurisdiction** to decide such questions" notwithstanding anything to the contrary in any other law. The deemed jurisdiction is confined to questions "relevant to the adjudication of the application" — the court does not acquire a general jurisdiction to try any title dispute between the parties.

**(e) Rule 103 changes the remedy, and this is where most litigants go wrong.** Because the order is deemed a decree, the challenge is a **first appeal under section 96** — to the district court or the High Court according to valuation — and **not** a revision under section 115, and **not** a miscellaneous appeal under Order XLIII. Nor can it be attacked in a fresh suit. Filing a revision is the single most common fatal error in this block; by the time the revision is dismissed as not maintainable, the ninety or thirty days for the appeal are long gone, and section 5 applications to condone that delay are met with the answer that the party chose the wrong remedy with eyes open.

**(f) Rule 104 preserves only a *pre-existing* suit.** If, on the date the Rule 97 or Rule 99 proceeding commenced, the obstructor already had a suit pending in which he sought to establish a right to present possession, the Rule 101/103 order is **subject to the result of that suit**. But a suit filed after the execution proceeding started is not saved — indeed it is barred by Rule 101's "not by a separate suit". So the obstructor's position depends heavily on whether he sued before the bailiff came.

**(g) Rules 105 and 106 supply the procedural spine, and they apply to Rule 58 claims too.** Rule 105 lets the court dismiss for the applicant's default or hear the matter ex parte on the opposite party's default. Rule 106 provides the cure: an application to set aside within **thirty days** of the order — or of knowledge of it, where notice was not duly served — on proof of sufficient cause. The *Explanation* to Rule 105 expressly extends this machinery to claims and objections under **Rule 58**, so a claimant whose claim petition was dismissed for default has a Rule 106 remedy rather than being driven to a suit.

**(h) There are two different thirty-day clocks and they are constantly confused.** **Article 129 of the Limitation Act** gives thirty days from the **date of resistance or obstruction** to make the Rule 97 complaint. **Rule 106(3)** gives thirty days from the **date of the order or of knowledge** to set aside a dismissal or an ex parte order. A decree-holder who takes symbolic delivery under Rule 36, waits three months while trying to negotiate with the occupant, and then files under Rule 97 is out of time under Article 129 — and his execution, otherwise perfectly good, is over.

**(i) Rule 98(2)'s detention power is real but narrow.** It applies only where the resistance was "without any just cause", by the judgment-debtor or someone at his instigation or on his behalf, or by a transferee *pendente lite*. It is capped at **thirty days**. It requires a finding, on evidence, of the instigation or the transfer date. It is not available against a stranger whose claim has merely been rejected on the merits — such a person's obstruction was not "without just cause" merely because he lost.
...
| Trigger | Provision | Interlocking Order/Rule | Limitation / fee | Application to file |
|---|---|---|---|---|
| Bailiff resisted while delivering possession | **O. XXI R. 97(1)** | R. 35 (occupant bound) / R. 36 (occupant not bound) | **Article 129 — thirty days** from the resistance | Application complaining of resistance, with the bailiff's report annexed |
| Auction-purchaser resisted after the sale certificate | R. 97 with **R. 95** | s. 65 vesting from the date of sale | Art. 129 — thirty days; Art. 134 — one year for R. 95 delivery | R. 95 application first; then R. 97 on resistance |
| Stranger dispossessed by the decree-holder or purchaser | **O. XXI R. 99(1)** | R. 100 orders on adjudication | **Article 129 — thirty days** from the dispossession | Application complaining of dispossession, seeking restoration |
| Obstructor's title has to be decided | **O. XXI R. 101** | Non-obstante clause overrides pecuniary and subject-matter limits | — | Ask for issues to be framed and evidence recorded; resist affidavit disposal |
| Obstructor took a transfer from the judgment-debtor after the suit was filed | **O. XXI R. 102** with **s. 52 TPA** | R. 98(2) — delivery directed; detention up to thirty days | — | Annex the certified plaint (date of institution) against the transfer deed |
| Obstruction continues after an order for delivery | **O. XXI R. 98(2)** | Contempt of Courts Act, 1971 as an alternative | — | Application for detention up to thirty days; police assistance under s. 151 |
| Adverse order after adjudication | **O. XXI R. 103** with **s. 96** | **Not** s. 115 revision; **not** O. XLIII | **Article 116 — 90 days** (to the High Court) / **Article 117 — 30 days** (to the district court) | **First appeal**, valued on the subject matter |
| A title suit was already pending when the execution proceeding began | **O. XXI R. 104** | The R. 101/103 order is subject to its result | — | Plead the pending suit and its number at the first hearing |
| Applicant absent; application dismissed | O. XXI R. 105(2) | R. 106 restoration | **Thirty days** under R. 106(3) | Restoration application on sufficient cause |
| Opposite party absent; ex parte order | O. XXI R. 105(3) | R. 106(1); compare O. IX R. 13 | Thirty days from the order or from knowledge where notice was not duly served | Application to set aside the ex parte order |
| A Rule 58 claim dismissed for default | R. 105 *Explanation* with R. 106 | Extends RR. 105–106 to R. 58 claims | Thirty days | Restoration application, not a fresh claim |
| Decree-holder wants the obstructor's possession decided **before** the bailiff goes | Not available under R. 97 | R. 97 is triggered only by actual resistance | — | Implead the occupant in the suit itself under **O. I R. 10(2)** — the only clean solution |
| Property in a village; possession to be delivered | O. XXI R. 35(2), R. 36 | Beat of drum and affixture; Gram Panchayat copy under R. 54(2) | — | Ensure the delivery warrant records the mode used |

::: info Fee and practice note — a Rule 97 proceeding is cheap to start and expensive to lose
An application under Rule 97 or Rule 99 is presented as a **miscellaneous application in the execution** and bears a fixed court fee under Schedule II — it is not valued on the market value of the property, because it is not a suit. That makes it a very cheap way to have a title question determined.

The sting is in **Rule 103**. Because the order is deemed a decree, the **appeal** against it is a first appeal under section 96, and in most States it is valued *ad valorem* on the value of the subject matter of the dispute. A party who defends a Rule 97 application casually, on a fixed-fee footing, and loses, may find that the appeal costs several lakh rupees in court fee alone. Two practical consequences:

1. **Treat the Rule 97 hearing as the trial**, because it is. Lead your full documentary and oral evidence, prove your documents, and get your case on the record — there is no second instance at which fresh evidence will be received as of right.
2. **Value the dispute realistically at the outset** and advise the client on the appellate exposure before the first hearing, not after the order.
...
**Ratio decidendi:** A third party in possession is entitled to be heard **before** he is dispossessed. Rules 97 to 101 as amended constitute a complete code; a stranger who resists is entitled to have his objection adjudicated under Rule 97 read with Rule 101, and he cannot be told to submit to dispossession first and to apply under Rule 99 afterwards. The executing court must decide his claim on the merits.

::: tip Practitioner Takeaway
"A person in possession who is a stranger to the decree is entitled to be heard before he is dispossessed; his objection must be adjudicated under Order XXI Rule 97 read with Rule 101, and he cannot be relegated either to a suit or to a post-dispossession application under Rule 99."
:::

**Silverline Forum Pvt. Ltd. v. Rajiv Trust, (1998) 3 SCC 723** — 2-Judge Bench.
*Facts:* Whether an obstructor claiming under the judgment-debtor was entitled to a full adjudication.

**Ratio decidendi:** Rule 97 covers obstruction by **any person**, but Rule 101 requires the court to determine only those questions which are "relevant to the adjudication of the application". Where the obstructor is a transferee *pendente lite*, **Rule 102** applies and the obstruction is removed without adjudication of his claim; where he claims independently, his claim must be tried. The court is not obliged to embark on a title enquiry merely because a title claim is asserted — it must first see whether the claimant is one to whom Rules 98 and 100 apply at all.
...
*Facts:* Whether a stranger must wait for actual obstruction before objecting to delivery of possession.

**Ratio decidendi:** A person in possession claiming an independent right may approach the executing court even before actual dispossession; the court has jurisdiction under Rules 97 to 101 to entertain and decide the objection, and the technicality that no "resistance" has yet occurred should not defeat the adjudication which the 1976 scheme contemplates.

::: tip Practitioner Takeaway
"A third party in settled possession under an independent claim need not wait to be physically dispossessed before invoking the jurisdiction of the executing court; the adjudicatory scheme of Rules 97 to 101 is available to him, and this Hon'ble Court has jurisdiction to determine his claim before delivery is effected."
:::

**Rahul S. Shah v. Jinendra Kumar Gandhi, (2021) 6 SCC 418** — 3-Judge Bench.
*Facts:* Directions to curb execution delay, including delay caused by third-party obstruction.

**Ratio decidendi:** Among the mandatory directions: the executing court "shall not entertain any objection to the execution of a decree which could have been raised at the stage of trial"; where a claim under Rules 97 to 106 is entertained, it must be decided **within sixty days** of filing, and if delayed, reasons must be recorded; and courts must impose costs where the obstruction is found to be an abuse.

::: tip Practitioner Takeaway
"In *Rahul S. Shah*, this Hon'ble Court directed that an application under Order XXI Rules 97 to 106 be adjudicated within sixty days of its filing, and that objections which could have been raised at the trial shall not be entertained in execution; the objection under reply rests on a document which the objector admittedly held throughout the trial, and is therefore not entertainable."
:::
...
2. **Filing a revision against a Rule 98 or Rule 100 order.** Rule 103 makes it a decree. The remedy is a **first appeal under section 96**. A revision under section 115 is not maintainable, and by the time it is dismissed the appeal period has run.
3. **Not producing the date of institution of the suit.** Rule 102 turns entirely on whether the obstructor's transfer post-dates the institution. A certified copy of the plaint with the filing endorsement, and the obstructor's deed, are the only two documents that matter in a large proportion of these applications — and decree-holders routinely fail to annex the first.
4. **Treating the Rule 97 hearing as a summary matter.** It is a trial. A party who leads no evidence, does not prove his documents and does not seek issues will lose a decree, with an *ad valorem* appeal as the only remedy.
5. **Filing a separate title suit while the Rule 97 application is pending.** Rule 101 bars it — "and not by a separate suit". Only a suit **already pending** when the execution proceeding commenced is saved, by Rule 104.
6. **For the obstructor: holding back a document for the appeal.** There is no second trial. Everything must go in before the executing court, because Rule 103 makes the order a decree and the appeal is on the record made below.
:::

::: warning Strategic timing — the possession endgame
**For the decree-holder, the real work is done in the suit, not in execution.** The clean way to avoid Rules 97 to 106 altogether is to implead every person in possession as a defendant under **Order I Rule 10(2)** at the outset, so that the decree binds them and Rule 35 applies. *Rahul S. Shah* now requires the trial court to ask about third-party interests at the threshold. A plaintiff who suppresses a known occupant to keep the suit simple buys himself a Rule 97 trial five years later.

**On the day of obstruction, get the bailiff's report right.** It must name the obstructor, state what was said, record the date and time, and be filed in court. That report is the foundation of the Article 129 limitation and of the Rule 98(2) finding on instigation. File the Rule 97 application within days, not weeks.

**For the obstructor, move before the bailiff, not after.** *Ashan Devi* permits a person in settled possession under an independent claim to approach the executing court before actual dispossession. That is a far better position than being locked out and then applying under Rule 99, because possession is nine points of the case and restoration under Rule 100 is discretionary in practice even when ordered in principle.

**Both sides: identify at the first hearing which of the three categories the obstructor is in** — (i) claiming through the judgment-debtor, (ii) a transferee *pendente lite* under Rule 102, or (iii) an independent claimant. The whole conduct of the proceeding follows from that classification, and courts appreciate an application that addresses it in its opening paragraph rather than after two years of evidence.

**Do not forget Rule 104.** If a suit was pending on the date the execution proceeding commenced in which the obstructor sought to establish a present right to possession, plead it immediately. It converts an adverse Rule 101 order from a final defeat into a provisional one.
:::

**Model prayer — application under Order XXI Rule 97**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** take on file this application under Order XXI Rule 97 complaining of the resistance and obstruction offered by the respondent on [date] as recorded in the report of the Nazir/Amin dated [•], filed within thirty days as required by Article 129 of the Limitation Act, 1963;
>
> **(b)** determine, under Order XXI Rule 101, all questions arising between the applicant and the respondent, including the questions of right, title and interest in the property described in the Schedule, and to frame issues and record evidence for that purpose;
>
> **(c)** hold that the respondent is a transferee from the judgment-debtor under sale deed dated [•], executed after the institution of the suit on [•], and is therefore a transferee *pendente lite* to whom, by force of **Order XXI Rule 102** read with section 52 of the Transfer of Property Act, 1882, nothing in Rules 98 and 100 applies;
>
> **(d)** direct under Order XXI Rule 98(2) that the applicant be put into possession of the property, with police assistance if necessary, and in the event of continued obstruction, order the detention of the judgment-debtor and of the respondent in civil prison for a term of thirty days;
>
> **(e)** award the applicant the costs of this application, the obstruction being frivolous within the meaning of the directions in *Rahul S. Shah v. Jinendra Kumar Gandhi*, (2021) 6 SCC 418; and
>
> **(f)** pass such further order as may be just.

**Model prayer — application under Order XXI Rule 99 by a dispossessed stranger**

> It is therefore most respectfully prayed that this Hon'ble Court may be pleased to:
>
> **(a)** hold that the applicant, who is not the judgment-debtor and was not a party to [suit number], was dispossessed of the property described in the Schedule on [date] by the decree-holder/auction-purchaser;
>
> **(b)** determine under Order XXI Rule 101 the applicant's independent right, title and interest in the said property, arising under registered sale deed dated [•] which predates the institution of the suit on [•], so that section 52 of the Transfer of Property Act and Order XXI Rule 102 have no application to the applicant;
>
> **(c)** direct under Order XXI Rule 100(a) that the applicant be restored to possession of the said property forthwith;
>
> **(d)** record that this order shall, under Order XXI Rule 104, be subject to the result of [suit number], which was pending on the date of commencement of the present proceeding; and
>
> **(e)** award costs.

| # | Checklist — resistance, obstruction and dispossession | Provision |
|---|---|---|
| 1 | Bailiff's report obtained, naming the obstructor and stating the date and time | O. XXI R. 97; Art. 129 |
| 2 | Application filed within **thirty days** of the resistance or dispossession | Article 129, Limitation Act |
| 3 | Obstructor classified — through the judgment-debtor / *pendente lite* / independent | RR. 98(2), 102, 101 |
| 4 | Certified copy of the plaint with the filing endorsement annexed | O. XXI R. 102; s. 52 TPA |
| 5 | Obstructor's title deed obtained and its date compared with the date of institution | O. XXI R. 102 |
| 6 | Issues sought and evidence led — the hearing treated as a trial | O. XXI R. 101 |
| 7 | Any suit pending on the date the proceeding commenced pleaded at the first hearing | O. XXI R. 104 |
| 8 | Prayer for delivery **and**, in the alternative, for detention under R. 98(2) | O. XXI R. 98(2) |
| 9 | *Rahul S. Shah* sixty-day timeline cited and an early date sought | (2021) 6 SCC 418 |
| 10 | Against an adverse order — **first appeal under s. 96**, never a revision | O. XXI R. 103 |
| 11 | Where dismissed for default or decided ex parte — R. 106 application within thirty days | O. XXI R. 106(3) |
| 12 | Costs claimed and quantified where the obstruction is frivolous | s. 35; *Rahul S. Shah* |

## Chapter consolidation — Order XXI as a single machine

Order XXI looks like 106 unrelated rules. It is in fact one machine with six moving parts, and every contested execution is a fight about which part the case has reached.

**One — the application.** Article 136 gives twelve years and no more; section 5 does not apply. The application under Rule 11 is a pleading, and the ten particulars in sub-rule (2) are its plaint. Rule 22 notice is mandatory where the decree is over two years old or where a legal representative, surety or assignee is proceeded against. Rule 17 permits amendment and preserves the original date. Payments outside court do not exist unless certified within thirty days under Article 125, and Rule 2(3) forbids the court from recognising them.

**Two — the choice of mode.** Section 51 lists the modes and Rule 30 permits them cumulatively. But arrest is hedged by the section 51 proviso — means plus refusal, on evidence, with written reasons — by the Rule 37 show-cause notice, by the Rule 40 inquiry, by the Rule 39 subsistence deposit, by section 56's absolute bar in the case of a woman, and by section 58's ceilings. Rule 41(2) is the practical starting point for everything: an affidavit of assets, available thirty days after the decree, backed by three months' detention for disobedience under Rule 41(3).

**Three — attachment.** The mode must match the species: seizure for movables in the debtor's possession, prohibitory orders for debts and shares, garnishee notices under Rules 46A to 46I, a charging order for a partner's interest, and a Rule 54 prohibitory order for immovables. Section 60's proviso protects a subsistence floor that cannot be waived. Section 64 voids post-attachment transfers **only as against claims enforceable under the attachment** — attachment confers no title and no charge — and section 64(2) exempts a contract registered before the attachment. Rule 55 and Rule 57(2) kill attachments automatically; the second of them, on the dismissal of an execution application without a continuation direction, is the most expensive silent failure in execution practice.

**Four — third-party claims.** Rule 58 obliges the executing court to adjudicate, to decide **all questions including title**, and produces an order that is a decree appealable under section 96. Its two provisos — property already sold, and designed delay — do the defensive work. A claim without a simultaneous Rule 59 application is worthless, because a sale during its pendency bars the claim itself.

**Five — sale.** Rule 64 permits sale only of so much as is necessary. The proclamation under Rule 66 is the document that makes or breaks everything downstream, and Rule 90(3) forecloses every ground that could have been taken when its terms were settled. Rule 68's fifteen days run from court-house affixture. Rules 72, 72A and 73 police the bidders. Rules 84 and 85 impose deposits that no court can extend. Then three windows — Rule 89 redemption, Rule 90 irregularity with substantial injury, Rule 91 no saleable interest — all governed by **sixty days under Article 127**. Rule 92 confirmation is ministerial once they close, and section 65 relates the purchaser's title back to the date of the sale.

**Six — possession.** Rule 95 delivers against the judgment-debtor and his post-attachment transferees. Everyone else falls into Rules 97 to 106: a complete adjudicatory code in which the executing court is deemed to have jurisdiction to decide title, decides it as a trial, and produces a decree. Rule 102 excludes transferees *pendente lite*. Rule 104 preserves only a suit already pending. **Thirty days under Article 129** to complain of resistance; thirty days under Rule 106(3) to undo a default.

::: tip The twelve sentences worth memorising
1. Article 136 gives twelve years from enforceability, and section 5 of the Limitation Act does not apply to an execution application.
2. An uncertified payment does not exist — Rule 2(3) forbids the court from recognising it, and Article 125 gives thirty days.
3. Notice under Rule 22 is mandatory where the decree is over two years old, or where an LR, surety or assignee is proceeded against.
4. Detention for a money decree requires **means plus refusal**, found on evidence and recorded in writing — inability to pay is not contumacy.
5. A woman cannot be arrested in execution of a money decree; section 56 is absolute.
6. Rule 41(2) — an affidavit of assets thirty days after the decree, enforced by three months in civil prison under Rule 41(3) — is the fastest lever in the Order.
7. Attachment creates no title and no charge; section 64 voids a subsequent transfer only as against claims enforceable under the attachment.
8. If an execution application is dismissed and the court does not direct that the attachment continue, the attachment is **deemed to have ceased** under Rule 57(2).
9. A Rule 58 claim must be accompanied by a Rule 59 application, and the resulting order is a decree — the appeal is a first appeal, not a revision.
10. Nothing that could have been said when the proclamation was settled can be said under Rule 90 afterwards; and irregularity without substantial injury never sets aside a sale.
11. Rules 84 and 85 are mandatory; on default there is no sale at all, and section 148 cannot enlarge a period fixed by the rule.
12. Obstruction to possession by **any person** is decided by the executing court under Rule 101 as if it were a suit, the order is a decree under Rule 103, and the complaint must be made within thirty days under Article 129.
:::

::: warning Before you file — the eight dates in every execution file
Open the file with a limitation sheet, and put these eight dates on it before anything else. Almost every execution that fails, fails on one of them.

1. **Date the decree became enforceable** — Article 136 runs twelve years from here, and where there was an appeal, it is the appellate decree that counts.
2. **Date of each defaulted instalment**, where the decree is payable by instalments — each generates its own twelve years.
3. **Date of any payment out of court** — thirty days under Article 125 to certify it, from either side.
4. **Date of the Rule 54 attachment order, and separately the date of affixture on the property** — Rule 54(4) makes the second date decisive against a bona fide purchaser.
5. **Date of any dismissal of the execution application** — Rule 57(2) kills the attachment from this date unless a continuation direction was recorded.
6. **Date of affixture of the proclamation on the court-house** — Rule 68's fifteen days run from here, not from the proclamation order.
7. **Date of the sale** — sixty days under Article 127 for Rules 89, 90 and 91, and section 65 vests title from this date on confirmation.
8. **Date of resistance or obstruction** as recorded in the bailiff's report — thirty days under Article 129 for the Rule 97 application, and one year under Article 134 for delivery under Rule 95.
:::
