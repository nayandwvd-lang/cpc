...
Migrated so far: **Sections 9–14**, **Orders VI, VII & VIII**, **Order XXI** (all 106 rules, in five blocks) and **Order XXXIX**. The rest follow.

## Published

| Provision | File |
|---|---|
| Sections 9, 10, 11, 12, 13, 14 | [`sections/sec-9-to-14`](/sections/sec-9-to-14) |
...
**First Schedule — Special suits and procedure**
- Orders XXII (death, marriage, insolvency of parties), XXIII (withdrawal and compromise), XXXII (minors), XXXIII (indigent persons), XXXIV (mortgages), XXXVII (summary suits)
