...
|---|---|---|
| "The Courts **shall** … have jurisdiction" | **Mandatory** | The civil court has no discretion to decline a civil suit. Jurisdiction is a duty, not a favour. |
| "(subject to the provisions herein contained)" | Internal qualifier | Subordinates S.9 to the rest of the Code (e.g. Ss. 11, 15–20, O.VII R.11). |
| "all suits of a **civil nature**" | Defining phrase | The subject-matter test. The word "civil" is not defined; it takes colour from Explanation I. |
| "**excepting** suits of which their cognizance is **either expressly or impliedly barred**" | **Exclusionary condition** | The only escape hatch. Two species of bar, and the burden of establishing either lies on the party asserting it. |

**Condition precedent to exclusion.** Ouster of the civil court's jurisdiction is never presumed. The party pleading the bar must point to (a) an express statutory provision excluding jurisdiction, or (b) a statute that creates a right *and* provides a self-contained machinery and remedy for its enforcement, from which exclusion is necessarily implied.
...
**Illustration 1 — The temple office.** *Ramaswamy v. Board of Trustees.* R claims he is the hereditary *archaka* of a village temple and is entitled to the *thattukazhi* (a share of offerings). The Board contends the dispute is religious and outside S.9. **Held in principle:** the claim is to an office and to emoluments — a civil right. That its proof requires the court to decide which family is entitled under religious custom is immaterial: Explanation I preserves jurisdiction.

**Illustration 2 — The tenancy ouster.** *Mehta v. Kapoor.* M sues K in the civil court for possession of a shop. K pleads that the State Rent Act vests exclusive jurisdiction over eviction in the Rent Controller. **Analysis:** if K is a tenant to whom the Act applies, the civil court's jurisdiction is expressly barred as to eviction. But if M's case is that K is a rank trespasser and never a tenant, the *jurisdictional fact* of tenancy must first be decided — and the civil court decides it.

**Illustration 3 — The service dispute.** An employee of a statutory corporation sues in the civil court alleging wrongful termination. Where the grievance is breach of a *statutory* rule or regulation governing his service, the civil court's jurisdiction is ordinarily excluded in favour of the statutory machinery. Where the grievance is breach of a purely *contractual* term not sourced in statute, the civil court retains jurisdiction.

**As a sword (Plaintiff).** S.9 is the plaintiff's charter. He invokes it to resist an ouster plea, to insist that the burden lies on the defendant, and to argue that the special forum's competence does not extend to the *particular* relief claimed (for example, a Rent Controller may evict but may not declare title).

**As a shield (Defendant).** The defendant deploys S.9 in reverse — as the foundation of an Order VII Rule 11(d) application, or as a preliminary issue under Order XIV Rule 2, contending the plaint is "barred by law".

::: warning Drafting Trap
Do not plead the ouster as a bare conclusion. An application saying only "the civil court has no jurisdiction" will fail. You must identify the **statute**, the **section**, the **tribunal** it creates, and demonstrate that the **relief actually claimed in the plaint** falls within that tribunal's competence.
:::
...
| Operative expression | Character | Consequence |
|---|---|---|
| "**No Court shall** proceed" | **Mandatory and prohibitory** | Once the conditions are satisfied the stay is not discretionary. The court has no option. |
| "proceed with the **trial**" | Limiting word | The bar attaches to the **trial**, not to institution, not to interlocutory orders. This single word carries enormous practical weight. |
| "**previously instituted** suit" | Condition precedent | Priority is fixed by date of *institution*, not by date of service or appearance. |
| "**directly and substantially** in issue" | Identity requirement | Not mere overlap; the matter must be the substantial subject of controversy in both. |
| "same parties, or … parties under whom they … claim litigating under the same title" | Identity requirement | Privity suffices; identity of capacity is essential. |
| "having **jurisdiction to grant the relief claimed**" | Competence requirement | The prior court must be competent to grant the relief claimed **in the subsequent suit**. |

**The five cumulative conditions.** Every one must be satisfied:

1. There are **two suits**, one previously instituted and one subsequently instituted.
2. The **matter in issue** in the subsequent suit is directly and substantially in issue in the previous suit.
3. Both suits are between the **same parties**, or parties claiming under them, **litigating under the same title**.
4. The previously instituted suit is **pending** in the same or any other competent court in India, or in a court established or continued by the Central Government beyond India, or before the Supreme Court.
5. That court has **jurisdiction to grant the relief claimed** in the subsequent suit.

**What the Explanation does structurally.** It is a *carve-out*, not an extension. Foreign *lis pendens* is not a bar. An Indian court may try a suit on the same cause of action even though a suit is pending in a foreign court. (Contrast S.13, which governs the *judgment* once the foreign court has decided.)

::: danger Fatal misconception
Section 10 does **not** oust jurisdiction. A decree passed in contravention of Section 10 is **not a nullity**. It is an irregularity, and the objection can be waived. Advocates who allow the trial to proceed and raise Section 10 for the first time in appeal will find the point has evaporated.
:::
...
**Illustration 1 — The mirror suits.** *Anand v. Bhaskar.* Anand sues Bhaskar at Nagpur for specific performance of an agreement to sell a plot. Three weeks later Bhaskar sues Anand at Nagpur for a declaration that the very same agreement was procured by fraud and is void, and for cancellation. The substantial matter in both is the validity and enforceability of the same agreement, between the same parties, in the same capacities. **The later suit's trial must be stayed.**

**Illustration 2 — Overlap is not identity.** *Cheema v. Dhillon.* Cheema sues Dhillon for a permanent injunction restraining interference with possession of a shop. Later Cheema sues Dhillon for recovery of arrears of rent for an earlier period. Possession is in issue in the first; the rate and quantum of rent in the second. Common questions exist, but the substantial controversies differ. **S.10 does not apply — apply for consolidation instead.**

**Illustration 3 — The capacity point.** *Estate of Farooqui.* F sues in his personal capacity to recover a loan. Later, as executor of his father's will, F sues the same defendant on a different debt owed to the estate. Same natural persons, different titles. **S.10 does not apply.**

**Illustration 4 — The summary suit.** Bank sues a borrower under Order XXXVII at Mumbai. The borrower had earlier sued the Bank at Pune alleging the loan account was wrongly debited. The borrower applies under S.10 to stay the Mumbai suit. **The Mumbai court may still decide the application for leave to defend**, because dealing with that application is not "proceeding with the trial".

**As a sword (Plaintiff).** Rarely used offensively. Its principal offensive value is to a plaintiff in the *earlier* suit who wishes to prevent the defendant from obtaining a competing decree elsewhere and to consolidate the battlefield in his chosen forum.

**As a shield (Defendant).** This is the defendant's provision. Faced with a second suit on the same controversy, the defendant files an application under S.10 read with S.151 at the **earliest opportunity**, before issues are settled, seeking a stay of trial, and simultaneously resists any attempt to advance the later suit.

::: warning Drafting Trap
An application under Section 10 that fails to annex a **certified copy of the plaint in the earlier suit** is worthless. The court must be able to compare the two plaints to determine whether the matters in issue are directly and substantially the same. Annex both plaints, both sets of issues if settled, and a comparative table.
:::
...
> *"Res judicata pro veritate accipitur"* — a matter adjudged is taken as truth.
> The doctrine rests on three maxims: **nemo debet bis vexari pro una et eadem causa** (no one should be vexed twice for the same cause); **interest reipublicae ut sit finis litium** (it is in the interest of the State that there be an end to litigation); and **res judicata pro veritate occipitur**.
...
**Illustration 1 — The partition suit and the omitted property.** *Ravindran v. Sudhakaran.* In Suit No. 112 of 2014 the brothers obtained a preliminary decree partitioning three items of ancestral property. In 2021 Ravindran sues for partition of a fourth item, admittedly ancestral and admittedly known to him in 2014. **Result:** barred by Explanation IV. The claim to the fourth item might and ought to have been made a ground of attack in the partition suit; a partition suit is by its nature a suit to divide the *whole* joint estate.

**Illustration 2 — The tenant's second defence.** *Kohli v. Sethi.* In an eviction suit Sethi defends solely on the ground that he committed no default in payment of rent, and loses. In execution he contends the notice terminating the tenancy was invalid. **Result:** barred. Explanation IV bars the defence he omitted, and Explanation VII carries the bar into execution.

**Illustration 3 — The mesne profits silently refused.** *Nagaraj v. Poornima.* Nagaraj sued for possession and mesne profits. The decree granted possession and was silent on mesne profits. He later files a fresh suit for mesne profits. **Result:** barred by Explanation V — the relief is deemed refused. His remedy lay in appeal or review at the time.

**Illustration 4 — Change of capacity defeats the plea.** *Iyer (personal) v. Iyer (as trustee).* A suit by Iyer personally to recover a personal loan is dismissed. He then sues the same defendant, as trustee of a temple trust, to recover trust monies. **Result:** not barred. He does not litigate under the same title.

**Illustration 5 — The wholly successful defendant.** *Dass v. Verma.* Verma successfully defends a suit for specific performance; the suit is dismissed on limitation, though the court records an adverse finding that the agreement was genuine. In a later suit Verma disputes the genuineness of the agreement. **Result:** not barred by that finding. Verma was wholly successful and had no occasion to appeal against the adverse finding.

**Illustration 6 — The village common.** *Grama Panchayat scheme litigation.* In 2009 residents A, B and C sued in a representative capacity under Order I Rule 8, with the court's permission and after notice, for a declaration that a pathway was a public way; the suit was dismissed on the merits. In 2023 resident D, who never appeared, files a fresh suit for the same declaration. **Result:** barred by Explanation VI, provided the earlier litigation was bona fide. D's only escape is to plead and prove collusion or want of bona fides.

**Illustration 7 — Explanation VIII in action.** A Court of Small Causes, competent to decide the issue of tenancy, finally decides in an eviction proceeding that Q is a tenant and not a licensee. Q later files a title suit in the District Court valued far beyond the Small Causes Court's pecuniary limit, asserting he is a licensee-turned-owner. **Result:** the finding on the tenancy issue binds him under Explanation VIII, though the Small Causes Court could never have tried the title suit.

**Illustration 8 — Serial execution objections.** A judgment-debtor objects in E.P. No. 40 of 2019 that the decree is inexecutable for vagueness of the property description, and loses. In E.P. No. 61 of 2022 he objects that the decree was passed without jurisdiction — a point available to him in 2019. **Result:** barred by Explanation VII read with Explanation IV, and by Section 47.

**As a sword (Plaintiff).** The plaintiff uses S.11 offensively to shut out defences: *"The defendant's plea of adverse possession stands concluded against him by the judgment and decree dated ____ in O.S. No. ____, and he is precluded from re-agitating it."* He also uses **issue** res judicata to shorten the trial — securing a finding that particular issues need not be tried at all.

**As a shield (Defendant).** The classic defensive use: a written statement pleading the bar of S.11, followed by an application under O.XIV R.2 to try it as a preliminary issue, or an application under O.VII R.11(d) where — and only where — the bar appears from the plaint and the admitted former judgment.

::: warning Drafting Trap
Res judicata is very often **not** a proper ground for rejection of the plaint under Order VII Rule 11(d). Rule 11(d) requires the bar to appear from the **statement in the plaint** alone. Establishing res judicata almost always requires the court to examine the pleadings, issues and judgment of the *former* suit — material outside the plaint. The correct route is a preliminary issue under Order XIV Rule 2, or a trial on the issue.
:::
...
**Illustration 1 — The default dismissal chased across States.** Menon's suit at Ernakulam for recovery of a loan is dismissed under Order IX Rule 8 for his non-appearance. He does not apply under Order IX Rule 9. He then files a fresh suit on the identical promissory note at Bengaluru. **Result:** barred by Order IX Rule 9 read with Section 12. The bar follows him into every court to which the Code applies.

**Illustration 2 — Withdrawal without liberty.** Sharma withdraws his suit for specific performance on the eve of trial, saying only that he does not wish to press it. The court permits withdrawal simpliciter. He files a fresh suit two months later. **Result:** barred by Order XXIII Rule 1(4) read with Section 12. He should have sought liberty under Rule 1(3).

**Illustration 3 — Abatement.** The sole defendant dies; the plaintiff fails to bring the legal representatives on record within time and the suit abates. A fresh suit against the legal representatives on the same cause is barred by Order XXII Rule 9(1) read with Section 12, unless the abatement is set aside.

**As a sword (Plaintiff).** Essentially none. Section 12 is a provision that operates *against* plaintiffs.

**As a shield (Defendant).** A clean, decisive plea. Where the earlier suit ended in default, withdrawal or abatement, the defendant need not prove any adjudication on the merits — merely the fact and manner of the earlier termination.

::: tip Practitioner Takeaway
Section 12 is the defendant's answer to the plaintiff who says *"the earlier suit was never decided on the merits, so res judicata does not apply."* Correct — and irrelevant, because a different bar applies.
:::
...
**Definitions to keep at hand (Section 2).** A "**foreign Court**" means a court situate outside India and not established or continued by the authority of the Central Government. A "**foreign judgment**" means the judgment of a foreign court.
...
**Illustration 1 — The non-submitting defendant.** A Singapore court passes a money decree against Dev, an Indian resident who was never in Singapore, never appeared, and never contracted to submit to Singapore jurisdiction. The decree-holder sues on the judgment in Delhi. **Result:** clause (a) — no competent jurisdiction by Indian private international law. The judgment is a nullity in India.

**Illustration 2 — Default judgment without evidence.** A New York court enters a default judgment for damages against an Indian company purely for failure to file an answer, without taking evidence. **Result:** clause (b) — not given on the merits. The Indian court will not treat it as conclusive.

**Illustration 3 — The foreign divorce.** Parties marry in India under the Hindu Marriage Act, 1955. The husband acquires residence abroad and obtains a decree of divorce from a foreign court on the ground of "irretrievable breakdown", a ground not available under the 1955 Act, the wife neither appearing nor submitting. **Result:** vulnerable under clauses (a), (b), (c) and (d). The foreign court applied a law other than the law under which the parties were married, and assumed a jurisdiction not recognised by the parties' matrimonial law.

**Illustration 4 — Suppressed service.** The decree-holder obtains an ex parte foreign decree by filing a false affidavit of service. **Result:** clauses (d) and (e) — natural justice and fraud.

**As a sword (Plaintiff / decree-holder).** The foreign decree-holder pleads S.13 affirmatively: the judgment is conclusive as to the matters directly adjudicated, and the burden lies on the defendant to bring himself within one of the six exceptions. Where the decree qualifies, he proceeds directly under **S.44A** and avoids a fresh trial altogether.

**As a shield (Defendant / judgment-debtor).** The judgment-debtor pleads the applicable exceptions with particulars, and — crucially — pleads them **in the execution proceeding** under S.47 if S.44A is invoked, or in the written statement if a suit is filed on the judgment.
...
**Illustration 1 — Presumption arises and holds.** A decree-holder produces a certified copy of a judgment of a court in Dubai against Faizal, who had been resident and employed in Dubai at the time of the suit and had entered appearance through counsel. **Result:** the presumption of competence arises under S.14 and is not displaced — indeed the record confirms residence and appearance.

**Illustration 2 — The contrary appears on the record.** The certified copy itself recites that the defendant "is a resident of Chennai, India, and has not appeared, service having been effected by publication only". **Result:** the contrary appears on the record; the presumption never arises. The decree-holder must prove competence affirmatively, and will very likely fail.

**Illustration 3 — Rebuttal by evidence.** The certified copy is silent on residence. The objector files an affidavit and leads evidence of his passport, Aadhaar, income-tax returns and employment record establishing continuous residence in India, and deposes he never appeared or submitted. **Result:** the presumption is displaced by proof of want of jurisdiction.

**Illustration 4 — No certified copy, no presumption.** The decree-holder produces a photocopy of the foreign judgment, uncertified. **Result:** Section 14 is not engaged at all. The condition precedent — production of a document purporting to be a certified copy — is unsatisfied.

**As a sword (Decree-holder).** Section 14 is the decree-holder's opening move. Produce the certified copy; invoke the mandatory presumption; and put the objector to proof. Resist any attempt to make you prove foreign law affirmatively at the threshold.

**As a shield (Judgment-debtor).** Attack in this order: (i) is it a certified copy at all? (ii) does the contrary appear on the record, so that no presumption arises? (iii) if it arises, rebut it with concrete evidence of non-residence, non-nationality and non-submission.

::: warning Drafting Trap
A judgment-debtor who merely **denies** jurisdiction in his objections has done nothing. Section 14 places the burden on him. He must plead the primary facts — where he resided, of what country he was a national, that he never entered appearance, that there was no jurisdiction clause — and support each with a document. Bare denial loses against a mandatory presumption.
:::
